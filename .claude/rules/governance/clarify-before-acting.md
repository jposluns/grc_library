...
- **Asking for a findable fact**. Surfacing a question whose answer the assistant could retrieve itself (a file location, a citation, a count, a version, where a term appears in the project's content, what an artefact currently says) instead of running the search or read and surfacing the answer. This spends the requestor's attention on the assistant's own retrieval work; it is the inverse of silent-picking and equally a discipline failure. Run the compute-first gate before forming any question.
...
| --- | --- | --- | --- |
| Documented decisions before action | N/A | GRC-01, GRC-04 | A.5.1, A.5.4 |
| Scope-bounded authorization | N/A | IAM-15 | A.5.15, A.5.18 |
| Investigation before destructive action | N/A | TVM-01 | A.5.27, A.8.16 |
| Change-management for scope expansion | N/A | CCC-01 to 03 | A.5.4, A.8.32 |
