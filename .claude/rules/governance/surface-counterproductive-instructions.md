...
| --- | --- | --- | --- | --- |
| Surface adverse effects before acting on an instruction | PO.5 | GRC-04, GRC-05 | A.5.4, A.5.36 | V15.1 |
| Confirm-before-destructive-action discipline | PO.5 | GRC-04 | A.5.4, A.5.18 | V15.1 |
| Scope-bounded authorization (an override covers the case it was given for) | PO.5 | IAM-15 | A.5.15, A.5.18 | V8.2 |
| Decisions traceable to a confirmation step | PS.1 | LOG-02, GRC-04 | A.8.15, A.5.4 | V16.2 |
