...
**Status: ACTIVE (umbrella 4.1, compile PR-37).** This directory is the structure of a standalone,
...
- **PR-38 (next):** g22 (pii-in-content), then g23 (internal-references), g24 (external-link-domains), same Pattern A SAFETY `scan` set. Then g20/g25 (2nd seam). EXCLUDE gate 51 (grc-only `.working/`-store coupled).
