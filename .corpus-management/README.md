...
**Status: ACTIVE (umbrella 4.1, compile PR-22).** This directory is the structure of a standalone,
...
- **PR-23 (next):** the last ALLOW gate, lint-gate-count-consistency (569L + direct-call check_file coupling, the heaviest). Then the vocabulary/config split to `defaults/grc/` (Phase-4).
