...
**Status: ACTIVE (umbrella 4.1, compile PR-36).** This directory is the structure of a standalone,
...
- **PR-37 (next):** the SAFETY `scan` set: g21 (secrets-in-content), g22 (pii-in-content), g23 (internal-references), g24 (external-link-domains), same Pattern A. Then g20/g25 (2nd seam). EXCLUDE gate 51 (grc-only `.working/`-store coupled).
