...
**Status: ACTIVE (umbrella 4.1, compile PR-33).** This directory is the structure of a standalone,
...
- **PR-34 (next):** the next SHARED `scan`-shape gates (g15 license-consistency, g17 section-anchors, g18 intra-doc-refs), same Pattern A. EXCLUDE gate 51 (grc-only `.working/`-store coupled). Ranked candidate list in the scoping memo.
