...
**Status: ACTIVE (umbrella 4.1, compile PR-25).** This directory is the structure of a standalone,
...
- **PR-26 (next):** Phase-4 PR-C, the mechanical wrapper-config wave (language / sections / markers / roles / scope / counts / standards profiles, each mirrored from its gate wrapper then migrated) OR the heavier non-ALLOW SHARED/SAFETY-mapped gates (new pattern per gate-homes.toml).
