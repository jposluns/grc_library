...
**Status: ACTIVE (umbrella 4.1, compile PR-34).** This directory is the structure of a standalone,
...
- **PR-35 (next):** g17 (section-anchors) then g18 (intra-doc-refs), same Pattern A `scan` shape. Then the SAFETY `scan` set g21-24. EXCLUDE gate 51 (grc-only `.working/`-store coupled). Ranked list in the scoping memo.
