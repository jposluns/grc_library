...
**Status: ACTIVE (umbrella 4.1, compile PR-14).** This directory is the structure of a standalone,
...
rule. The gate register carries ten gate transfers (lint-language, grc gate 2, compile PR-5; lint-unbalanced-fences, grc gate 66, compile PR-6; lint-nested-markdown-links, grc gate 68, compile PR-7; lint-ungated-dashes, grc gate 82, compile PR-8; lint-bare-normative-shall, grc gate 56, compile PR-9; lint-links, grc gate 3, compile PR-10; lint-required-sections, grc gate 19, compile PR-11; lint-citations, grc gate 5, compile PR-12; lint-section-placement, grc gate 38, compile PR-13; lint-shall-near-uncertainty, grc gate 9, compile PR-14); no hooks have been transferred yet.
...
- **PR-15 (next):** further corpus-bucket gate transfers (clean ALLOW-mapped: lint-todo-marked-done, lint-positional-backlog-tokens, lint-stub-documents, ...; lint-roles deferred as heavier) and/or the vocabulary/config split to `defaults/grc/` (Phase-4).
