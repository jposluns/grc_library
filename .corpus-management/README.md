...
**Status: ACTIVE (umbrella 4.1, compile PR-19).** This directory is the structure of a standalone,
...
- **PR-20 (next):** remaining heavier ALLOW gates (lint-directional-dependency 279L bespoke-fence, lint-gate-count-consistency 569L, lint-placeholder-leakage cross-gate, lint-roles --root+register) - each careful individual handling, best fresh-focus. And/or the vocabulary/config split to `defaults/grc/` (Phase-4).
