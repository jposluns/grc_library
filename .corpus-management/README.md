...
**Status: ACTIVE (umbrella 4.1, compile PR-32).** This directory is the structure of a standalone,
...
- **PR-33 (next):** the SHARED/SAFETY-mapped gates (the non-ALLOW gate-wave needing a NEW transfer pattern; gate-51 was the dead-end per the abandoned-retro; research-heavy). Maintainer-steered 2026-09-15.
