...
directory. Any link in a deliverable document, whether an inline ``](target)`` (bare,
titled, or angle-bracketed) or a reference-style ``[label]: target`` definition, whose
