...
paragraph). A field name starts with an ASCII letter and runs to its
closing colon without an asterisk, so it may contain hyphens, slashes,
parentheses and underscores. A run whose non-last lines all
