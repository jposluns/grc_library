...
Engine/wrapper split (compile PR-14): this engine carries the PURE check (the uncertainty
and mandatory patterns, the window, ``check_file``) and a ``run`` that groups + reports; the
