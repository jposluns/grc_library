...
def render_corpus_link_manifest(figures):
    ...
    (render_type_doc_rows), plus the curated llms.txt corpus links
    (CURATED_CORPUS_LINKS). The repo-root and on-site links are not corpus-path
    targets and are excluded, matching the gate's scope."""
    ...
    lines = [
        ...
        "target the site links, with its website location and link text. Gate 75 "
