...
| Pack-hygiene scrub fragments | `pack-hygiene-fragments/` (SWEPT 2026-07-24) | Verbatim removal archive for the pack-hygiene generalization of the distributable pack; a completed one-off working dir, swept to the grc_library_private archive by the §1.22.3 initial sweep (git history retains it). No longer in-repo. | pack-hygiene staging (2026-07-11); applied #842; swept #1140-era |
