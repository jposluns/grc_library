...
6. `governance/register-data-retention-schedule.md:104` (1.0.15 to 1.0.16, the verifier-caught sixth fix, at the seventh carrier location): the AI-Impact-Assessments basis cell re-grounded as the organization's canonical assessment-retention floor "informed by the EU AI Act Article 9 risk-management obligations (which prescribe no retention period)".
