...
For the 2026-06-21 run, the full FR-1 through FR-111 backlog is enumerated in `2026-06-21-r1.md` §3 Page-by-Page Findings. For the 2026-06-22 run, the full FR-112 through FR-133 backlog is enumerated in `2026-06-22-r1.md` §8 Remediation Backlog. The high[critical] subset across both runs is summarised below; remaining items are tracked in the detail files.
