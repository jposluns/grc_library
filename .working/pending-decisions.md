...
**Status:** 1 pending (a narrow scratch-ingestion-shape sub-question for the new-format ATLAS v2026.05 data, surfaced 2026-06-28; the parent ATLAS decision was resolved by the maintainer's "Act on atlas" direction, and the 4 PRI-* picks were confirmed, both rotating out at the next handoff)
