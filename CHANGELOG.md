...
**Closes FR-46 DPO consolidation** (medium, P1.5; second half of FR-46 after PR #210's Privacy Officer rename). Maintainer-approved option (A) per PR #210's DPO scope assessment: corpus-wide rename of "DPO" and "Data Protection Officer" to "Chief Privacy Officer" as the canonical library role title. The canonical equivalence convention is documented in two surfaces per the C-1 maintainer choice: (1) [`governance/register-role-authority.md`](governance/register-role-authority.md) CPO row carries an inline equivalence statement naming DPO as the GDPR-jurisdiction analogue and pointing at the local-statute-specific examples; (2) [`privacy/README.md`](privacy/README.md) gains a Role terminology section pointing back to the register. 27 corpus files modified across privacy, supply-chain, AI, security, governance, compliance domains and [`docs/template-quickstart.md`](docs/template-quickstart.md). Six jurisdiction annexes (Brazil, India, Kenya, Malaysia, Nigeria, Turkey) retain "DPO" as the regulatory term of the local statute, each gaining a one-line bridge note pointing back to the role-terminology convention. The [`supply-chain/procedure-supplier-onboarding-security-review.md`](supply-chain/procedure-supplier-onboarding-security-review.md) §135 escalation outlier (originally "DPO → CISO → Chief Privacy Officer") is fixed to "Chief Privacy Officer → CISO → Executive Management". The [`governance/register-glossary.md`](governance/register-glossary.md) DPO entry cross-references the role authority register. [`tools/build-portal.py`](tools/build-portal.py) hardcoded string collapsed from "Chief Privacy Officer or Data Protection Officer" to "Chief Privacy Officer"; [`docs/portal.md`](docs/portal.md) and [`docs/maturity-scorecard.md`](docs/maturity-scorecard.md) regenerated. Intentionally retained "DPO" / "Data Protection Officer" occurrences (privacy notice field, supplier-questionnaire regulatory question, Malaysia citation row, glossary acronym entry, GDPR-article quotations) document a single surface where the regulatory term applies and not the library's canonical-role label. **Surface-level consolidation of FR-47 (DPO ambiguous role)**: the three-way label drift FR-47 named ("Privacy Lead / Acting DPO", "Privacy Officer / DPO", "CIO acting DPO") is collapsed to consistent "Chief Privacy Officer" usage with "acting" qualifier for the CIO interim role; formal FR-47 closure pending maintainer review. Library `2026.06.195 → 2026.06.196`; README `1.9.66 → 1.9.67`.
