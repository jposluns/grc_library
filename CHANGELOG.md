...
**2026-07-14 | 2026.07.400 | PR #912** - FR-201 vulnerability-remediation-SLA single-source completion (TODO §3.68, partial): a full-corpus recheck found the earlier claim that no other document diverged had been over-stated. Four clear carriers were re-anchored to the vulnerability-management procedure as the single source of truth (their restated tables replaced by citations, one looser value tightened to match), and four genuinely divergent values needing maintainer judgment (including intentionally separate supplier-tier bars) were routed rather than changed. Also batched the prior PR's post-merge QA.
