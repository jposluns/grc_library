...
**Library Version:** 2026.06.218 (CalVer, library-wide; see [`specification-master-project.md`](specification-master-project.md) §4.5)\
**README Version:** 1.9.89 (semantic per-document version for this file)
