...
**Library Version:** 2026.07.12 (CalVer, library-wide; see [`specification-master-project.md`](specification-master-project.md) §4.5)\
**README Version:** 1.9.373 (semantic per-document version for this file)
