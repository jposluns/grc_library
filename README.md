...
**Library Version:** 2026.07.42 (CalVer, library-wide; see [`specification-master-project.md`](specification-master-project.md) §4.5)\
**README Version:** 1.9.403 (semantic per-document version for this file)
