...
**Library Version:** 2026.09.1234 (CalVer, library-wide; see [`specification-master-project.md`](specification-master-project.md) §4.5)\
**README Version:** 1.11.321 (semantic per-document version for this file)
...
- [`guardrails/CLAUDE.md`](guardrails/CLAUDE.md)
