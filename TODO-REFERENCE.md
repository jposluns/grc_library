...
### 2.25 Governance traceability and coverage expansion (umbrella; maintainer-directed 2026-07-23, H, XL)
...
### 2.25.3 Canadian public-sector authority coverage (consolidated with 2.22; CANADA-PRIORITY, H, L)
...
### 2.25.4 AI assurance and evaluation content (H, L)
...
### 2.25.5 Governance-maturity measurement model (maintainer-directed 2026-07-23; M, M)
...
### 2.26.1 OSCAL adoption decision and model-scope lock (maintainer-directed 2026-07-23; H, S)
...
### 2.26.2 OSCAL stable-identifier layer (S, M)
...
### 2.26.3 OSCAL metadata-field alignment (S, M)
...
### 2.26.4 OSCAL catalog pilot: one domain, generated, gated (maintainer-directed 2026-07-23; M, XL)
...
### 2.26.5 OSCAL profiles and crosswalks for framework alignments (M, L)
...
### 2.28 AI jurisdiction annex + ref ingest: Singapore Model AI Governance Framework for Agentic AI (M, M)
...
### 2.29 Latin-American privacy jurisdiction annexes + corpus alignment for the newly-held primaries (M, M)
...
### 2.30.2 Name the AI human overseer in the role-based training surfaces (M, S-M)
...
**Depends on:** none (the Article 26(2) competence-training-authority clause is in the AI EU annex, closed 1.28 / #1683).
...
### 2.25.2 Control-to-policy-instrument coverage: international AI-governance authorities (consolidated with 2.15; M, M)
...
### 2.26 OSCAL machine-readable representation (umbrella; maintainer-directed 2026-07-23, H, XL)
...
**Maintainer ruling + vision (2026-08-08, audience audit): KEEP PUBLIC.** When someone forks the repo, this is the skill that helps them manage their own repo properly. Most of the proprietary grc_library tooling that is not going into AIQT is expected to merge INTO this skill, so once the AIQT and CorpusManagement skills are loaded there should be very little left over. That vision needs a dedicated discussion when this item is picked up; do not build without it.
...
### 4.29 `/adopt` adjustment + non-destructive tooling-update mode (maintainer-directed 2026-07-19, L)
...
### 6.6 Java EE / Jakarta EE security standard (L)
