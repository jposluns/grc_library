...
### 2.13 Cross-document control and timing contradictions (audit 2026-07-02, item 11 + routed notes remaining)
...
- **(L-d, XS) Verbless "ensure that" sentences.** [`compliance/policy-compliance-and-audit-management.md`](compliance/policy-compliance-and-audit-management.md):41 ("The CEO ensures that resourcing and independence of audit functions.") and :59 (broken "to ensure that adherence to ... programs"); the #566 sweep found the class has more carriers than first grepped: the data-classification Purpose-line instance was FIXED in the C8 PR (that file was being edited anyway), and [`security/standard-data-loss-prevention.md`](security/standard-data-loss-prevention.md):21 ("It ensures that consistent protection of sensitive data...") joins the two originals as the third open carrier.
...
- **P2 (fill significant gaps)**: 13 items (2.1-2.10 the FR deepenings FR-59 / 60 / 70 / 99 / 15 / 23 / 63 / 74 / 154 / 41, 2.11 publications-assessment, plus the 2026-07-02 audit clusters 2.13 cross-document contradictions and 2.14 generated-surface drift; 2.12 external-citation corrections fully closed).
