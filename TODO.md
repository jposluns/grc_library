...
Apply-work (validate-then-apply) on the reference-breadth delivery in `grc_library_scratch` (PR #163, `inbox/reference-breadth-2026-07-12/`; MANIFEST + CANDIDATES). A worklist of held-but-uncited citation candidates from the 63-doc ref ingest, ~20 target documents (9 High). Run via `/reference-audit` new-ingest mode; the 9 High rows are the natural first slice (EDPB Guidelines 4/2019, 05/2020, 01/2022, 9/2022 to the matching privacy docs; Commission Implementing Decision (EU) 2021/915 to template-dpa-article-28; ANPD Resolution 18/2024 to annex-privacy-brazil; SOR/2018-64 to annex-privacy-canada; AICPA TSP 100 to register-canonical-citations; NIS2 Implementing Regulation (EU) 2024/2690 to annex-nis-2-implementation). Candidates are hypotheses: re-read each target + source clause and re-confirm "not already cited" at apply (checks were at 8c62ac5; ai/ rows are in the actively-changing delta region). Version-sensitive [V] rows: confirm current upstream this turn. Split into coherent per-PR bundles (EDPB-privacy cluster, eIDAS annex, NIS2/CER pair, AICPA register row, non-EU jurisdiction annexes); the eIDAS/implementing-reg rows also add a canonical-citations row in the same PR; the matrix TSC-column mapping is the deferred single-file sensitive change (register-coverage-gaps line 170) needing a `/matrix-fit` follow-up. Non-urgent; independent of the AI-domain delta; schedule after the delta + website-critical-path work. **PROGRESS 2026-07-13 (overnight): the `lc` held-and-currency-confirmed rows are APPLIED** (each verified verbatim against the held source, with a canonical-citations register row): the four High EDPB-privacy citations, 4/2019 to privacy-by-design (#866), 05/2020 to consent-management (#867), 01/2022 to data-subject-rights (#868), 9/2022 to breach-response (#869), plus the Medium EDPB 07/2022 to transfer-impact-assessment (#873). **The remaining rows are version-sensitive `[V]`; per the maintainer's 2026-07-13 direction the ASSISTANT now confirms their currency itself via WebSearch/WebFetch (the VM directive), rather than routing them, then applies.** APPLIED: AICPA TSP 100 to register-canonical-citations (#876), the genuine internal inconsistency (the Trust Services Criteria are cited corpus-wide but were absent from the register); upstream currency confirmed this turn (2026-07-13) against the AICPA and Deloitte-DART pages, current form is the 2017 Trust Services Criteria with revised points of focus 2022, added as a new `## AICPA assurance criteria` register block. Commission Implementing Decision (EU) 2021/915 to template-dpa-article-28 (#877), the controller-processor Article 28(7) SCCs named in the DPA template's Section 11 and framework-alignment table plus a new register row; currency confirmed upstream this turn (adopted 4 June 2021, in force 27 June 2021, no amendments), with the accuracy guard that 2021/915 is NOT a Chapter V transfer mechanism (those are Decision (EU) 2021/914). ANPD Resolution CD/ANPD No. 18/2024 to annex-privacy-brazil (#878), the encarregado/DPO regulation cited in the Brazil annex's DPO bullet plus a new register row; currency confirmed upstream this turn (enacted 16 July 2024, DOU 17 July 2024, in force, no amendment). Canada Breach of Security Safeguards Regulations (SOR/2018-64) to annex-privacy-canada (#879), the PIPEDA breach regulation cited in the annex's breach bullet for the 24-month breach-record retention and prescribed report/notification content, plus a new register row; currency confirmed upstream this turn (in force 1 November 2018, no amendment; PIPEDA remains in force after CPPA/Bill C-27 lapsed). EDPB Opinion 28/2024 to policy-privacy (#880), the AI-models data-protection opinion cited at §4.7 (AI training-data governance) for the training-data lawful-basis and model-anonymity questions; currency re-confirmed upstream this turn (adopted 17 December 2024, not superseded), and the existing register row's Last-verified refreshed to 2026-07-13 (the opinion was already in the register from the 2026-06-30 population, so no new row). NIS2 Commission Implementing Regulation (EU) 2024/2690 to annex-nis-2-implementation (#881), named in three places (the Article 21 measures section, the Article 23(3) significance-threshold section, and the framework-alignment table) with the load-bearing scope caveat that it binds only the digital-infrastructure and digital-service entity types in its scope, plus a corrected locator (the table read "Article 21(5) and 27"; the act's basis is Article 21(5) and 23(11), Article 27 being the entity registry) and a new register row; currency + legal basis confirmed upstream this turn (adopted 17 October 2024, basis Article 21(5)+23(11) of Directive 2022/2555). EU LSA guidelines to annex-privacy-european-union (#882), the EDPB Guidelines 8/2022 on identifying a controller or processor's lead supervisory authority cited at the one-stop-shop / regulatory-authorities bullet plus a new register row; currency confirmed upstream this turn (Version 2.1, adopted 28 March 2023 with a minor correction of 28 September 2023, superseding WP244 rev.01; the delivery candidate's v2.1 was confirmed correct against the primary-source PDF version-history table after a mid-apply WebSearch-summary slip to v2.0 was caught by the verifier and reverted). **ALL of the maintainer's named §3.57 `[V]` rows are now APPLIED (#876 AICPA, #877 EU 2021/915, #878 ANPD 18/2024, #879 SOR/2018-64, #880 EDPB 28/2024, #881 NIS2 2024/2690, #882 EDPB 8/2022), each with upstream currency confirmed this turn and each refute-verified.** The Medium Brazil follow-up (Resolution CD/ANPD No. 4/2023, sanctions dosimetry, to the Brazil annex's enforcement section) was applied in #883; currency confirmed upstream this turn (enacted 24 February 2023, DOU 27 February 2023, amends Resolution 1/2021, in force). ONE residual now keeps this item open: the deferred matrix TSC-column mapping (register-coverage-gaps line 170), a single-file sensitive change needing a `/matrix-fit` follow-up (not a quick citation apply). When that residual is scheduled and closed, rotate §3.57 to DONE. A Medium Brazil follow-up candidate also surfaced in the delivery (Resolution CD/ANPD No. 4/2023, sanctions dosimetry, to the annex's enforcement section); it can ride a later Brazil-annex PR. See [`pending-decisions.md`](.working/pending-decisions.md).
