...
### 3.141 Per-account worker concurrency greater than 1 via config-dir snapshots (design drafted 2026-07-26, M, L) `[machinery]` `[private]`
...
### 3.80 Credit-offload: multi-worker QA + research queue (maintainer-co-designed 2026-07-15, L, XL; cross-repo) `[private]`
