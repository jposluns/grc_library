...
- **Editorial consistency** (4 remaining): FR-46 (role-name "Chief" inconsistency, **maintainer-decided**: rename to "Chief Privacy Officer" + assess DPO scope — pending PR), FR-47 (DPO ambiguous role), FR-48 (H2 numbering patterns drift), FR-49 (Governance heading drift). **Closed**: FR-50 (PR #207 NIST `Rev. N`), FR-51 (PR #208 ISO 27001 `Annex A.X`), FR-52 (PR #209 review-frequency `AND`).
