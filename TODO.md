...
- **FR-174 (H, S) [fitness:G] — surfaced 2026-06-27 (/fitness trust-recovery)**: P2 CISO-notification timing conflict across three values, one of them intra-document: [`security/procedure-security-incident-response.md`](security/procedure-security-incident-response.md):48 ("within 4 hours for P2") vs :79 ("CISO notified within 1 hour") vs [`security/sop-incident-escalation-matrix.md`](security/sop-incident-escalation-matrix.md):41 ("CISO: within 2 hours"). Reconcile to one authoritative surface; stricter is 1 hour.
- **FR-175 (H, S) [fitness:I] — surfaced 2026-06-27 (/fitness trust-recovery)**: India DPDPA in-force conflict: [`privacy/annex-privacy-jurisdiction-index.md`](privacy/annex-privacy-jurisdiction-index.md):137 ("entered into force April 2025") vs [`privacy/jurisdictions/annex-privacy-india.md`](privacy/jurisdictions/annex-privacy-india.md):28 (notified 13 Nov 2025; phased commencement to circa Nov 2026 / May 2027). Verify the notification date against an external source at fix time, then reconcile the index to the annex.
...
- **FR-176 (M, S) [fitness:B] — surfaced 2026-06-27 (/fitness trust-recovery)**: key-rotation cadence axis mismatch: [`security/policy-encryption-and-key-management.md`](security/policy-encryption-and-key-management.md):77 expresses rotation by data classification, while [`security/framework-cryptographic-key-lifecycle.md`](security/framework-cryptographic-key-lifecycle.md):39 expresses it by key type. Reconcile to a single axis or add a crosswalk.
...
- **FR-179 (M, S) [fitness:G] — surfaced 2026-06-27 (/fitness trust-recovery)**: NIST SP 800-61 r3 is paired with the superseded Rev.2 title ("Computer Security Incident Handling Guide") at [`security/sop-incident-escalation-matrix.md`](security/sop-incident-escalation-matrix.md):95, [`security/sop-security-ticket-reporting-scheme.md`](security/sop-security-ticket-reporting-scheme.md):94, and [`operations/framework-it-service-management.md`](operations/framework-it-service-management.md):98; the canonical register [`governance/register-canonical-citations.md`](governance/register-canonical-citations.md):92 carries the Rev.3 title. Align the three citers to the register's Rev.3 title.
- **FR-180 (M, S) [fitness:G] — surfaced 2026-06-27 (/fitness trust-recovery)**: incident severity-vocabulary divergence: [`resilience/procedure-security-incident-reporting-and-escalation.md`](resilience/procedure-security-incident-reporting-and-escalation.md):89 uses Low/moderate/high/critical, while [`security/procedure-security-incident-response.md`](security/procedure-security-incident-response.md):124 and [`security/sop-incident-escalation-matrix.md`](security/sop-incident-escalation-matrix.md):27-32 use the P1-P4 vocabulary, with no crosswalk. Add a crosswalk or align the vocabulary.
...
- **FR-183 (L, XS) [fitness:B] — surfaced 2026-06-27 (/fitness trust-recovery)**: password-hashing floor looser in the auth standard ([`security/standard-authentication-and-password-management.md`](security/standard-authentication-and-password-management.md):54) than in [`security/policy-encryption-and-key-management.md`](security/policy-encryption-and-key-management.md):92; add a cross-reference.
- **FR-184 (L, XS) [fitness:B] — surfaced 2026-06-27 (/fitness trust-recovery)**: WPA floor differs (confirm intentional): [`security/standard-remote-working-security.md`](security/standard-remote-working-security.md):122 (WPA2 acceptable, home) vs [`security/policy-network-communications-security.md`](security/policy-network-communications-security.md):101 (WPA3-Enterprise, facilities).
...
- **FR-189 (L, XS) [fitness:F] — surfaced 2026-06-27 (/fitness trust-recovery)**: crisis-EOC activation authority unstated in [`resilience/procedure-crisis-management-eoc-activation.md`](resilience/procedure-crisis-management-eoc-activation.md) (Step 2 line 51, records line 79); mitigated by the Limitations clause; add a pointer to where activation authority is defined.
- **FR-190 (FYI, S) [fitness:F] — surfaced 2026-06-27 (/fitness trust-recovery)**: procedure-depth variation: thin baselines (e.g. [`resilience/procedure-security-incident-reporting-and-escalation.md`](resilience/procedure-security-incident-reporting-and-escalation.md):62-64) vs thick (privacy breach-response, compliance CAPA); mitigated by Limitations clauses. Informational.
- **FR-191 (L, XS) [fitness:G] — surfaced 2026-06-27 (/fitness trust-recovery)**: PIR deadline 5 vs 10 (scoped): [`security/procedure-security-incident-response.md`](security/procedure-security-incident-response.md):206-207 (single-domain P2, 5 business days) vs [`resilience/procedure-cross-domain-incident-coordination.md`](resilience/procedure-cross-domain-incident-coordination.md):149 (Joint PIR P2, 10 business days); add a forward reference (may be intentional).
