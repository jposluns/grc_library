...
### 2.12 External-citation corrections (audit 2026-07-02, items 7 and 10 remaining; H/M, S-M)

Citation-accuracy defects re-validated at source (items 6, 8, and 9 closed in the C6 PR; both remaining items are upstream-CONFIRMED as of 2026-07-02, so the fixes are unblocked multi-citer value sweeps).

- **(item 7, M, M; upstream-CONFIRMED 2026-07-02: V6-2022, launch 2022, certification-mandatory from 2023-01-31 per WBASCO) BASC v6 year.** [`governance/register-canonical-citations.md`](governance/register-canonical-citations.md):203 says BASC v6 (2022); ~12 live docs cite "v6 2023" (e.g. [`supply-chain/procedure-supplier-audit.md`](supply-chain/procedure-supplier-audit.md):23,92,175, [`supply-chain/procedure-supplier-due-diligence.md`](supply-chain/procedure-supplier-due-diligence.md):23,164, [`security/policy-network-communications-security.md`](security/policy-network-communications-security.md):154). Register-vs-citer split is itself an internal-consistency defect; upstream confirms the register (V6-2022; the citers' "2023" is the certification-transition date): reconcile the citers to the register with a bare-token grep.
- **(item 10, H, S; upstream-CONFIRMED 2026-07-02: Resolucao CD/ANPD no 15/2024, 3 business days, doubled for small agents; Res. no 2 is the small-agents regulation) Brazil breach citation.** [`privacy/procedure-data-protection-and-privacy-breach-response.md`](privacy/procedure-data-protection-and-privacy-breach-response.md):177,321 and [`privacy/jurisdictions/annex-privacy-brazil.md`](privacy/jurisdictions/annex-privacy-brazil.md):41 cite "ANPD Resolution CD/ANPD No. 2, 2 business days"; the breach-notification regulation is likely Resolucao CD/ANPD no 15/2024 (3 business days; Res. No. 2 is the small-agents regulation). Upstream confirmed: correct all three carriers to Resolucao CD/ANPD no 15/2024 with the 3-business-day deadline (the two hedge clauses can then drop).
