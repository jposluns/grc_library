...
- **Mirror the shipped rotation gate family** (the closed rotation backlog item, now in DONE): gate 57 (the static marked-done detector) plus the D5 PR-time CHANGELOG-asserts-closure check, the sibling member of the "post-merge bookkeeping parity" gate family; this gate is the QA-cadence half of that family.
...
- **P4 (adopter experience)**: 8 subsections (4.1-4.8; 4.9 closed in PR #295, 4.10 closed in PR #468 + this PR).
