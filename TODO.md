...
### 3.25 Decision-tree residual acronym coverage (S, XS) — added 2026-07-04 (#637 verifier F5)

Five acronyms used in [`docs/decision-tree.md`](docs/decision-tree.md) neither expand at first use nor resolve in [`governance/register-glossary.md`](governance/register-glossary.md): CPRA (line 83), PIA (line 140), BC and CM (lines 145-146, the BC/DR and BC/CM compounds), ML (line 99, the AI/ML compound). Add glossary rows (and inline expansions where first-use style warrants); check the same five against other adopter-facing docs/ files while in the glossary.
