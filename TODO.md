...
### 1.6 Risk-model internal consistency (audit 2026-07-02, item 3 remaining, L)

One remaining risk-model defect from the 2026-07-02 read-only audit (item 1, the residual-risk formula contradiction, closed in the C1 PR; item 2, the FR-171 authority residual in the methodology, closed in the C2 PR).
