...
**Phase 1 remaining (P1.5 wrap-up, P1.6, P1.7).** Single-document or single-cluster polish PRs. Phase 1 originally included P1.1 (README polish, closed by PR #172), P1.2 (ERM completion, closed by PR #178), P1.3 (access-control polish, closed by PR #169), and P1.4a (six small singleton mediums, closed by PR #179); those are shipped. P1.4 was split into P1.4a + P1.4b per the "always split when in doubt" discipline (FR-33 high[critical] warranted dedicated treatment).
...
- **P1.5 — Editorial consistency cluster** (1 remaining: FR-48, medium). H2 numbering drift (multi-doctype structural rename; deferred). Closed: FR-46 (PR #210 + PR #218), FR-47 (surface-consolidated in PR #218), FR-49 (PR #223 — "Governance" → "Governance and accountability", 14 files), FR-50 (PR #207), FR-51 (PR #208), FR-52 (PR #209). **PR #219** closed the at-top "Role-name convention" notes follow-up.
...
- **P2.1 — Privacy completion** (1 remaining: FR-41 medium — AI Article 22 + EU AI Act + FRIA workflow). Closed: FR-37 (PR #224 joint controller template), FR-38 (PR #225 Article 12(5) checklist), FR-39 (PR #226 EU representative Art 27 appointment process), FR-40 (PR #227 PIPL Articles 38-40 operationalised), FR-42 (PR #228 DPO independence Art 38(3)/(6) framework).
