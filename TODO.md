...
- **FR-199 (L, XS) [full-qa] — surfaced 2026-06-27 (/full-qa trust-recovery)**: register soft-law "Current version" column-format inconsistency at [`governance/register-canonical-citations.md`](governance/register-canonical-citations.md):285-290 (mixes rev.01 / WP216 / Version 2.1 / Opinion 28/2024); cosmetic. **PR-E content verified (handoff carry-forward): normalize the WP216 and EDPB Opinion 28/2024 cells to `Original (no later revision)`; NOT "1.0 ..." (no such version designation exists on either source, would fabricate).**
- **Adopter-guide casing residue (L, XS) [validate-pr #421]**: [`docs/adopter-guide.md`](docs/adopter-guide.md):60 carries "Core Reference Set" (title case) while the README heading/body and adopter-guide:83 use lowercase "Core reference set"; lowercase :60 to match. Out-of-window finding from PR #421's `/validate-pr` (line 60 was a fork-contents enumeration not in the FR-182 day-one scope); fold into the next adopter-guide touch.
