...
- **AIDA-in-force framing** (from the corpus-wide AIDA scan). The reconcile of [`ai/policy-ai-compliance.md`](ai/policy-ai-compliance.md) §7.2/§12 to the AIDA-lapsed framing (Bill C-27 died at the January 2025 prorogation; Canada has no in-force federal AI statute, per the `grc_library_ref` legislation register) caught two other carriers: (a) [`dev-security/standard-security-baseline-and-standards-reference.md`](dev-security/standard-security-baseline-and-standards-reference.md):115 presents "Canada's AIDA requires: ... Treat as near-term compliance target" as a live requirement (a genuine accuracy error, reword to lapsed framing + cite the in-force TBS Directive on ADM / ISED Voluntary Code); (b) [`ai/checklist-ai-algorithmic-compliance.md`](ai/checklist-ai-algorithmic-compliance.md):122 a "Synthesized from: ... Canada AIDA 2024" provenance note (softer, historical-synthesis provenance, but the "2024" dating is off, reword to the lapsed/successor framing). The checklist file is also WS 0.4's (#787) target, so its :122 fix folds into #787; the security-baseline reword is this item.
- **OECD AI Principles year designation** (from the #785 `/validate-pr`, out-of-window). [`ai/policy-ai-compliance.md`](ai/policy-ai-compliance.md) §12 cites "OECD AI Principles 2023" while §1.1 cites "the OECD AI Principles (2019 Recommendation as updated 2024)", two different revision-year designations for one source in one document. Reconcile to a single source-verified form (the held OECD Recommendation is OECD/LEGAL/0449, adopted 2019; confirm whether the revision is 2023 or 2024 before settling the designation, a `/claim-fit`-class currency check, best folded into WS 0.4's `/claim-fit` pass).

Surfaced 2026-07-10 during #785.
