...
- **Wire the TIA into the docs that reference it (L, S) — surfaced 2026-06-30 (#483, FR-34)**: the new [`privacy/template-transfer-impact-assessment.md`](privacy/template-transfer-impact-assessment.md) is listed in the README and the document-index register, but four existing docs reference a TIA without linking the now-existing instrument: [`privacy/template-dpia.md`](privacy/template-dpia.md) (its line ~33 defers TIAs to "a separate template"), [`privacy/jurisdictions/annex-privacy-european-union.md`](privacy/jurisdictions/annex-privacy-european-union.md) ("SCCs must be supplemented by a TIA"), [`privacy/procedure-privacy-impact-and-cross-border-transfer.md`](privacy/procedure-privacy-impact-and-cross-border-transfer.md) (Step 4 / Step G, the controlling process), and [`privacy/register-cross-border-data-flow.md`](privacy/register-cross-border-data-flow.md) (its TIA-reference field). A small discoverability PR adding the cross-reference links; each touched doc is a versioned-body change needing a Version+Date co-bump (note the cross-border procedure Owner is the CIO). Kept separate from #483 per always-split-when-in-doubt.
