...
**Audience-relocation note (2026-08-08, PR #1458):** items 3.142 (/sitrep pack skill), 4.31 (pack-methodology publication), 3.197 (portal-disposition tooling), and the TF-3 recurring re-vendor check relocated to the private planning backlog (audience audit; numbers permanent, union-checked). The maintainer ruled 4.1 stays public (see its vision note).
