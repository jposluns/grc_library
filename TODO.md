...
**Canonical values LOCKED 2026-06-22 (maintainer "accept all 6 as recommended"; apply these in the criticals remediation batch):** FR-137 → DSAR retention **3 years** (align records-standard:79 + the privacy procedure). FR-138 → scrub CPPA-as-live; cite **PIPEDA Schedule 1** principles (not invented section numbers) + a "CPPA pending reintroduction" note; consider Quebec Law 25 where rights are stronger. FR-139 → **1h RPO is binding; line :99's "24h for Tier 1" is the error** (tighten Tier-1 backup cadence to meet 1h; 24h belongs to lower tiers).
