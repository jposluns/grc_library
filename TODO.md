...
### 1.6 Risk-model internal consistency (audit 2026-07-02, items 2-3 remaining, H, L)

Two remaining coupled risk-model defects from the 2026-07-02 read-only audit (item 1, the residual-risk formula contradiction, closed in the C1 PR: the methodology now carries the canonical re-scored Residual likelihood x Residual impact model). They share the risk taxonomy / scoring model; each sub-item is a distinct fix.
