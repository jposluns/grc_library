...
**Canonical values LOCKED 2026-06-22 (maintainer "accept all 6 as recommended"; apply these in the criticals remediation batch):** FR-139 → **1h RPO is binding; line :99's "24h for Tier 1" is the error** (tighten Tier-1 backup cadence to meet 1h; 24h belongs to lower tiers).
