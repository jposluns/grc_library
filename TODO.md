...
- **P1 (fix errors and prevent recurrence)**: 4 items (1.1 FR-48, 1.4 audit-gate candidates, 1.5 reference version-currency, plus the 2026-07-02 audit cluster remainder: 1.8 DSAR conflicts).
