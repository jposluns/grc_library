...
Decided 2026-06-23 (maintainer triage): **build them all** from the 2026-06-22 review (S2, S3; the original S1 retention-consistency gate having shipped); **S4 added 2026-06-29** (maintainer-endorsed, from the #458 `/retro` / Sweep 75). Each is a `lint-*.py` + 4-surface wiring + regression fixture; one gate per PR to keep diffs reviewable.
