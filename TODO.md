...
P1 currently holds the **1.26** quality-machinery series (a goal-description umbrella plus its public pack-distribution phases 1.26.2 to 1.26.4, on hold pending the Priority-3 tooling); the private phase 1.26.1 and the former P1 items 1.22 / 1.23 / 1.19.13 moved to the private `P-TODO.md` in the 2026-07-31 public/private split. Point-fix items are opened and closed in place as they arise; the closed ones live in `.working/DONE.md`, not here.
...
**UNBLOCKED and to be completed as we go, with focus on aiqt.ai (maintainer-directed 2026-08-02).** The prior hold (follow the P3 tooling wave to avoid consolidating a moving target) is LIFTED: the maintainer directed that tooling and pack alignment be integrated on an ongoing basis ("integrate as we go ... considering our own tools and the pack and their alignment"), not deferred to a post-P3 big bang. The directional considerations below, especially separating the pack into a standalone public repository that grc_library consumes, are now under active analysis in the private `aiqt_strategy.md` (dual-family refined), for the aiqt.ai discussion; the maintainer registered aiqt.ai as the focused public product (the cleanlanguage.ai model). The pack-authoring-direction (aiqt authors vs grc_library authors and aiqt publishes) is the headline decision in that analysis.
