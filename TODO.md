...
- **P1.5 — Editorial consistency cluster** (2 remaining: FR-48, FR-49, both medium). H2 numbering drift, Governance heading drift. Closed: FR-46 (PR #210 Privacy Officer rename + PR #217 DPO consolidation), FR-47 (surface-consolidated in PR #217; formal closure pending maintainer review), FR-50 (PR #207), FR-51 (PR #208), FR-52 (PR #209).
...
- **P2.11 — FR-47 DPO ambiguous role**: surface-consolidated in PR #217 (the three-way label drift collapsed to consistent "Chief Privacy Officer" usage + register equivalence note + glossary cross-reference); formal closure pending maintainer review.
...
- **Editorial consistency** (2 remaining): FR-48 (H2 numbering patterns drift), FR-49 (Governance heading drift). **Closed**: FR-46 (PR #210 Privacy Officer rename, 36 files; PR #217 DPO consolidation, 27 files + 6 jurisdiction-annex bridges + register equivalence note + privacy/README waypoint), FR-47 (surface-consolidated in PR #217; formal closure pending maintainer review), FR-50 (PR #207), FR-51 (PR #208), FR-52 (PR #209).
