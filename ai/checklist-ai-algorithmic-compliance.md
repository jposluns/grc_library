...
| C2 | Training data poisoning controls in place (OWASP LLM03): data provenance validated; integrity controls applied; adversarial data injection tested | | | | |
| C3 | Model inversion and membership inference risks assessed (OWASP LLM06): risk assessment documented; mitigations implemented where risk is material | | | | |
