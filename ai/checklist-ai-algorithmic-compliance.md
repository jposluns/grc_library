...
The checklist is completed by the AI System Owner in the first instance, reviewed by the CISO, and reviewed by the Data Protection Officer for items in Section B. For high-risk AI systems (Tier 1), the completed checklist is submitted to the AIGC for approval before deployment.
...
*Synthesized from: EU AI Act Art. 11, 13; ISO/IEC 42001:2023 §8.4; ISO/IEC 42005:2025 §5.7, §6.3; NIST AI RMF Govern function; Canada Treasury Board Algorithmic Impact Assessment*
...
| A11 | AI system impact level assessed and recorded (little-to-no, moderate, high, or very high, aligned to Canada Treasury Board Algorithmic Impact Assessment Levels I to IV), scoring the impact on individuals' rights and freedoms; their equality, dignity, privacy, and autonomy; their health and well-being; their economic interests; and environmental-ecosystem sustainability; the recorded level drives the proportionate controls | | | | |
...
| B7 | Training data has been subject to a re-identification risk assessment; residual re-identification risk is documented and accepted by the Data Protection Officer | | | | |
...
| D6 | AI-generated content transparency implemented per EU AI Act Art. 50: as a PROVIDER, synthetic audio, image, video, or text outputs are marked as artificially generated in a machine-readable format (Art. 50(2)), except for assistive standard-editing or non-substantially-altering functions and law-authorized uses; as a DEPLOYER (Art. 50(4)), deep-fake image, audio, or video is disclosed (for evidently artistic, creative, or satirical work, limited to disclosing its existence in a manner that does not hamper the work), and AI-generated text informing the public on matters of public interest is disclosed unless it underwent human review or editorial control with a person holding editorial responsibility | | | | |
| D7 | Reversibility and duration of the decision's impacts assessed and recorded (reversible, likely reversible, difficult to reverse, or irreversible; and brief, lasting months, lasting years, or perpetual), consistent with the Canada Treasury Board Algorithmic Impact Assessment impact axes; the assessment informs the human-review pathway (D2) and any escalation | | | | |

---

## Section e: regulatory compliance

*Synthesized from: EU AI Act 2024 (Regulation (EU) 2024/1689); Canada TBS Directive on Automated Decision-Making and ISED Voluntary Code (AIDA lapsed with Bill C-27 at the January 2025 prorogation); UK AI regulation white paper (CP 815) and government response (CP 1019); ISO/IEC 42001:2023; NIST AI RMF Govern function*
...
| E2 | Canada automated-decision-making governance assessed and documented: applicability of the TBS Directive on Automated Decision-Making determined (binding on federal institutions subject to the Policy on Service and Digital; a leading-practice benchmark otherwise); ISED Voluntary Code commitments considered for generative-AI systems; AIDA tracked as a lapsed planning indicator (Bill C-27 died on the 2025-01-06 prorogation; the responsible Minister has stated it will not return in its original form), monitored for any successor AI-governance instrument rather than treated as pending reintroduction | | | | |
| E3 | UK AI regulation framework reviewed: the five cross-sectoral principles mapped to AI-governance controls; ICO AI and data protection guidance and applicable sector regulators' AI guidance considered | | | | |
