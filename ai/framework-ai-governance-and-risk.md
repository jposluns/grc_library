...
A change is "material" for the purposes of triggering reassessment if any of the following applies. These thresholds are the library default; an organization may calibrate them in its own configuration.
