...
**Related Documents:** `ai/framework-ai-governance-and-risk.md`, `ai/standard-ai-model-risk.md`, `ai/procedure-ai-model-risk-assessment.md`, `ai/matrix-ai-model-risk-control-to-lifecycle-mapping.md`, `ai/template-model-card.md`, `ai/template-system-card.md`
**Classification:** Public
**Category:** AI Governance
**Review Frequency:** 6 to 12 months and upon material model, data, threat, regulatory, or assurance change
**Repository Path:** `ai/framework-ai-model-risk.md`
