...
- **NIST SP 800-218A**: Secure Software Development Practices for Generative AI and Dual-Use Foundation Models; model scanning (PW.7.2), provenance via a software bill of materials and Supply-chain Levels for Software Artifacts (PS.3.2), and weekly production-endpoint scanning with triage and a remediate-or-accept decision (RV.1.2, RV.2.1, RV.2.2)
