...
- **High-risk** (Article 6 and Annex III): AI systems intended to be used as a safety component of a regulated product, or that are themselves such a product (Article 6(1)), and AI systems in the eight Annex III areas: biometrics, critical infrastructure, education and vocational training, employment and workers' management, access to essential private and public services, law enforcement, migration/asylum/border control, and administration of justice and democratic processes.
