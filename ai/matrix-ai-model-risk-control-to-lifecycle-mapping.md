...
**Related Documents:** `ai/framework-ai-model-risk.md`, `ai/standard-ai-model-risk.md`, `ai/procedure-ai-model-risk-assessment.md`, `ai/template-model-card.md`, `ai/template-system-card.md`, `ai/guideline-adversarial-evaluation-suite-development.md`
**Classification:** Public
**Category:** AI Governance
**Review Frequency:** 6 to 12 months and upon material model, data, framework, threat, or assurance change
**Repository Path:** `ai/matrix-ai-model-risk-control-to-lifecycle-mapping.md`
