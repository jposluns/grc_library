...
- **Federal executive-branch AI policy (OMB M-25-21, M-25-22, and M-26-04)** directs federal agencies, not the public: M-25-21 sets agency AI governance and minimum risk management practices for high-impact AI, M-25-22 directs agencies to write data-use, testing-access, lock-in, and high-impact compliance terms into AI contracts, and M-26-04 directs agencies to require the Unbiased AI Principles and minimum transparency artefacts in LLM contracts. An organization that is a federal agency applies them directly; one that sells AI to a federal agency meets them as contract terms. The memoranda are version-sensitive (M-26-04 sunsets on 11 December 2027 unless extended). See [`ai/jurisdictions/annex-ai-us-federal.md`](jurisdictions/annex-ai-us-federal.md) for the per-regime detail.
