...
- **Texas Responsible Artificial Intelligence Governance Act (TRAIGA)** (House Bill 149, 89th Texas Legislature 2025; Texas Business and Commerce Code Chapters 551 and 552), a comprehensive state AI-governance statute that binds a person who conducts business in Texas, produces a product or service used by Texas residents, or develops or deploys an artificial-intelligence system in Texas. It prohibits developing or deploying AI with the sole intent to manipulate human behaviour to incite harm, AI for social scoring, and AI intended to unlawfully discriminate against a protected class, and it carries biometric-identifier provisions; the Texas Attorney General has exclusive enforcement authority, with no private right of action. Effective 1 January 2026; the effective date is version-sensitive.
