...
- **Federal executive-branch AI policy (OMB M-25-21, M-25-22, and M-26-04)** directs federal agencies, not the public: M-25-21 sets agency AI governance and minimum risk management practices for high-impact AI, M-25-22 directs agencies to include contract terms on IP rights and lawful use of government data, privacy, testing access, vendor lock-in, and high-impact compliance, and M-26-04 directs agencies to require the Unbiased AI Principles and minimum transparency artefacts in LLM contracts. A covered agency applies them directly; an organization that sells AI to a covered agency meets them as contract terms. Executive Order 14365 separately directs federal action against state AI laws, including litigation and preemption proceedings, so the state-law position below is version-sensitive, as are the memoranda (M-26-04 sunsets on 11 December 2027 unless extended). See [`ai/jurisdictions/annex-ai-us-federal.md`](jurisdictions/annex-ai-us-federal.md) for the per-regime detail.
