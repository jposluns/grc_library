...
- Audit criteria: ISO/IEC 42001:2023, EU AI Act, NIST AI RMF, OWASP LLM Top 10, and/or internal standards.
- Evidence required.
- Audit timeline.
...
5.4 Reports are retained for a minimum of 7 years in the compliance document repository, per the audit-records floor in [`compliance/policy-compliance-and-audit-management.md`](../compliance/policy-compliance-and-audit-management.md) Section 4.7.1 and the retention schedule ([`governance/register-data-retention-schedule.md`](../governance/register-data-retention-schedule.md)).
