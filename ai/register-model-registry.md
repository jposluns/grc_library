...
3. The AI Governance Maintainer reviews the registry at minimum quarterly for completeness and accuracy.
...
This register is a public-domain structural baseline. The completeness of a populated registry depends on the maturity of MLOps tooling and the discipline of model promotion. The register is not a substitute for the model card or for the impact assessment; it is the inventory and lineage layer that connects them.
