...
**Domain:** AI / Dev Security
**Version:** 1.2
**Status:** Active
**Effective Date:** 2026-05
**Next Review:** 2027-05
**Audience:** Software Engineers, Platform Engineers, DevOps, DevSecOps, AI/ML Engineers, Infrastructure Engineers, Security Engineers
**Repository Path:** `ai/standard-ai-and-agentic-development-security.md`
**Licence:** CC0 1.0 Universal

**Parent:** Security Baseline and Standards Reference
**Related:** Developer Security Requirements Standard; DevOps Security Requirements Standard; Production Security Requirements Standard

**Companion documents:**
- `ai/guide-ai-security-technical-implementation.md` — implementation patterns, code examples, CI/CD configuration, reference architectures
- `ai/guide-ai-adversarial-test-reference.md` — adversarial test case library, red team methodology, tooling guidance

**Related GRC cross-references:**
- Privacy Management Programme — PIA obligations for AI systems processing personal data
- AI Risk Register — live AI risk tracking
- Third-Party AI Due Diligence Procedure — vendor assessment for AI services and model providers
- Physical Security Standard — physical controls for servers hosting AI workloads
- Authentication Standard — authentication requirements referenced in §§9, 17
- Logging and Monitoring Standard — SIEM and retention requirements
- Data Retention Schedule — retention periods for AI audit logs and training data
- BYOD Policy — governs personal device access to AI-enabled corporate applications
