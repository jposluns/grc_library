...
| ISO/IEC 42001:2023 | §8.1 (Operational planning and control); A.9.3 (Objectives for responsible use of AI system, incl. human-oversight objectives) | Human oversight embedded in the AI management system's operating controls (sections 4.1 to 4.4). |
