...
**Related Documents:** `ai/framework-ai-governance-and-risk.md`, `ai/standard-ai-security-and-risk.md`, `ai/procedure-ai-system-impact-assessment.md`
**Classification:** Public
**Category:** AI Governance
**Review Frequency:** 6 to 12 months and upon material AI governance change
**Repository Path:** `ai/template-ai-system-register.md`
