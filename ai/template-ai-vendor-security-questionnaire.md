...
This template is a public-domain baseline. AI provider questionnaires evolve quickly; new threat vectors and regulatory expectations may require additional sections. Adopting organisations adapt the template to their procurement workflow and the specific provider category.
