...
This procedure is a public-domain baseline. The specific forum cadence, reviewer pool, and recording tooling are organisation-specific. The procedure expresses outcomes, not a vendor-specific implementation.
