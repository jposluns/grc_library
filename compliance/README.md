...
This directory contains compliance management policies, registers, audit governance artefacts, cross-sector regulation annexes, and industry-sector compliance sub-directories. All content is released under CC BY-SA 4.0.
...
| Financial Services | [`compliance/financial-services/`](financial-services/) | Banks, investment firms, insurers, payment institutions, financial-market infrastructures; DORA (EU), SOX (US). |
| Healthcare | [`compliance/healthcare/`](healthcare/) | Healthcare providers, payers, medical-device manufacturers, healthcare technology platforms. |
| Energy and Utilities | [`compliance/energy-and-utilities/`](energy-and-utilities/) | Electricity, gas, water, district heating, renewable-energy operators; ICS/OT-centric regulations. |
| Telecommunications | [`compliance/telecommunications/`](telecommunications/) | Telecom network operators, ISPs, internet exchange points, electronic communications service providers. |
| Public Sector | [`compliance/public-sector/`](public-sector/) | Government agencies, public bodies, and cloud-service providers to public sector; FedRAMP (US). |

Each sub-directory has its own README listing the artefacts within and the regulations covered.
...
### Financial-services sub-directory artefacts
...
| Type | Title | Path |
| --- | --- | --- |
| Annex | Energy and Utilities Sector Requirements Annex | [`compliance/energy-and-utilities/annex-energy-and-utilities-sector-requirements.md`](energy-and-utilities/annex-energy-and-utilities-sector-requirements.md) |

### Telecommunications sub-directory artefacts

| Type | Title | Path |
| --- | --- | --- |
| Annex | Telecommunications Sector Requirements Annex | [`compliance/telecommunications/annex-telecommunications-sector-requirements.md`](telecommunications/annex-telecommunications-sector-requirements.md) |

### Public-sector sub-directory artefacts
