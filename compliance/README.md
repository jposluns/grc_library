...
This directory contains compliance management policies, registers, and audit governance artefacts. It also hosts trade compliance programme references aligned to internationally recognized supply-chain security frameworks. All content is released under CC0 1.0 Universal.
...
- ~~Audit planning procedure~~ *(active)*
- ~~Corrective and preventive action (CAPA) procedure~~ *(active)*
- ~~AEO IT self-assessment procedure~~ *(active)*
- ~~CTPAT compliance controls register~~ *(active)*
- ~~PIP compliance controls register~~ *(active)*
- ~~Compliance obligations register template~~ *(active)*
- ~~Trade compliance programme gap assessment template~~ *(active)*
- ~~Sector annex: financial services~~ *(active)*
- ~~Sector annex: healthcare~~ *(active)*
- ~~Sector annex: transportation and logistics~~ *(active)*
