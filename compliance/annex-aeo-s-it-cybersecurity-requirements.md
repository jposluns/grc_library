...
| IT systems are regularly backed up to ensure that continuity | Cloud-based site recovery service; backup schedule; disaster recovery plan | [`resilience/procedure-backup-and-recovery.md`](../resilience/procedure-backup-and-recovery.md) |
