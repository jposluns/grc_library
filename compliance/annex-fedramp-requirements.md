...
**Repository Path:** [`compliance/annex-fedramp-requirements.md`](annex-fedramp-requirements.md) 
...
This annex is a public-domain navigation aid. FedRAMP authorisation requires the FedRAMP-mandated artefacts, a federal sponsor or marketplace listing, and engagement with a 3PAO; this library does not produce authorisation by itself. Adopting organisations consult the official FedRAMP programme documentation and engage a 3PAO before commencing authorisation work. This annex is not a substitute for FedRAMP programme guidance.
