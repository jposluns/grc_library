...
- Pharmacies, pharmacy benefits managers, and prescription processors.
- Medical device manufacturers and software-as-a-medical-device (SaMD) operators.
- Healthcare technology platforms, electronic health record vendors, and telehealth providers.
- Business associates and service providers to any of the above.
