...
| ISO 27001:2022 | ISO/IEC 27001:2022 Annex A | Annex A control numbers and §6–§10 clauses |
...
| AEO/AEO-S | UK HMRC Authorised Economic Operator (Security and Safety) | Requirement area headings |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Governance | Governance Library Charter | [`governance/charter-governance-library.md`](../governance/charter-governance-library.md) | GRC-01, GRC-02 | §5.1, §5.2, §6.1 | GV.OC, GV.RM | — | Programme governance | §5.1, §7.5 | Pillar I (Customs-Business Partnership) | Management commitment |
| Governance | Policy: Governance and Risk Management | [`governance/policy-governance-and-risk-management.md`](../governance/policy-governance-and-risk-management.md) | GRC-01, GRC-02, GRC-03 | §5.2, §6.1, §6.2 | GV.RM, GV.OC | — | Programme governance | §5.1, §6.1 | — | Management commitment |
| Governance | Policy: Exception and Risk Acceptance Management | [`governance/policy-exception-and-risk-acceptance-management.md`](../governance/policy-exception-and-risk-acceptance-management.md) | GRC-04, GRC-05 | §6.1.3, §8.2 | GV.RM, ID.RA | — | — | §6.1, §10 | — | Risk management |
...
| Governance | Procedure: Supplier Security and Privacy Assurance | [`governance/procedure-supplier-security-and-privacy-assurance.md`](../governance/procedure-supplier-security-and-privacy-assurance.md) | STA-01, STA-02, STA-03 | A.5.19, A.5.20, A.5.21, A.5.22 | GV.SC, ID.SC | Business partner requirements | Third-party security | §8.6 | Pillar I (Standard 6) | Business partners |
| Governance | Register: Document Index and Classification | [`governance/register-document-index-and-classification.md`](../governance/register-document-index-and-classification.md) | GRC-01 | §7.5 | GV.OC | — | — | §7.5 | — | Documentation security |
...
| Domain | Document Title | Path | CSA CCM v5 | ISO 27001:2022 | NIST CSF 2.0 | CTPAT | PIP | BASC v6 | WCO SAFE | AEO/AEO-S |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Risk | Policy: Enterprise Governance and Risk Management | [`risk/policy-enterprise-governance-and-risk-management.md`](../risk/policy-enterprise-governance-and-risk-management.md) | GRC-01, GRC-02, GRC-03 | §5.3, §6.1, §6.2 | GV.RM, ID.RA | — | Programme governance | §5.1, §6.1 | — | Management commitment; Risk management |
| Risk | Standard: Enterprise Risk Management | [`risk/standard-enterprise-risk-management.md`](../risk/standard-enterprise-risk-management.md) | GRC-03, GRC-04, GRC-05 | §6.1.2, §6.1.3 | ID.RA, GV.RM | — | Risk assessment | §6.1 | — | IT security risk management |
| Risk | Procedure: Risk Register | [`risk/procedure-risk-register.md`](../risk/procedure-risk-register.md) | GRC-04, GRC-05 | §6.1.2, §6.1.3, §9.1 | ID.RA, GV.RM | — | Risk assessment | §6.1, §9.1 | — | IT security risk management |
...
| Domain | Document Title | Path | CSA CCM v5 | ISO 27001:2022 | NIST CSF 2.0 | CTPAT | PIP | BASC v6 | WCO SAFE | AEO/AEO-S |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Compliance | Policy: Compliance, Audit, and CAPA Management | [`compliance/policy-compliance-and-audit-management.md`](policy-compliance-and-audit-management.md) | GRC-06, GRC-07, GRC-08 | §9.2, §9.3, §10.1, §10.2 | GV.OC, ID.IM | — | Programme governance | §9.2, §10 | — | IT controls review and testing |
| Compliance | Register: Global Regulatory Applicability | [`compliance/register-global-regulatory-applicability.md`](register-global-regulatory-applicability.md) | GRC-01, GRC-06 | §4.1, §4.2, §6.1 | GV.OC, GV.RM | — | Programme governance | §4.1, §6.1 | — | Management commitment |
| Compliance | Register: BASC IT and Information Security Responsibilities | [`compliance/register-basc-it-responsibilities.md`](register-basc-it-responsibilities.md) | GRC-01, GRC-02 | §5.3, §6.1, §9.1 | GV.OC, GV.RM | — | — | §5.1, §6.1, §7.2, §7.5, §8.1, §8.3, §8.4, §8.5, §9.1, §9.2, §10 | Pillar I (Standard 6) | All AEO-S IT requirement areas |
| Compliance | Register: BASC IT Compliance Monitoring and KPIs | [`compliance/register-basc-it-compliance-kpis.md`](register-basc-it-compliance-kpis.md) | GRC-04, GRC-08 | §9.1 | GV.OC, ID.IM | — | — | §9.1 | — | IT controls review and testing |
...
| Security | Policy: Acceptable Use | [`security/policy-acceptable-use.md`](../security/policy-acceptable-use.md) | HRS-01, HRS-02 | A.5.10, A.6.2, A.8.1 | GV.PO, PR.AT | — | Employee security | §7.2 | — | Personnel security |
...
| Security | Standard: Data Classification and Handling | [`security/standard-data-classification-and-handling.md`](../security/standard-data-classification-and-handling.md) | DSP-01, DSP-02, DSP-03 | A.5.12, A.5.13, A.8.10 | PR.DS, PR.IP | — | Data protection | §7.5, §8.4 | Pillar II (ICT security) | Documentation security |
...
| Operations | Procedure: Media Handling and Transport | [`operations/procedure-media-handling-and-transport.md`](../operations/procedure-media-handling-and-transport.md) | DSP-04, DSP-05 | A.7.10, A.8.10 | PR.DS | — | Data protection | §7.5, §8.4 | — | Documentation security |
...
| Domain | Document Title | Path | CSA CCM v5 | ISO 27001:2022 | NIST CSF 2.0 | CTPAT | PIP | BASC v6 | WCO SAFE | AEO/AEO-S |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Resilience | Policy: Business Continuity and Disaster Recovery | [`resilience/policy-business-continuity-and-disaster-recovery.md`](../resilience/policy-business-continuity-and-disaster-recovery.md) | BCR-01, BCR-02 | A.5.29, A.5.30 | RC.RP, RC.CO | — | Business continuity | §8.1 | — | IT systems backup and continuity |
| Resilience | Standard: Business Continuity and Disaster Recovery | [`resilience/standard-business-continuity-and-disaster-recovery.md`](../resilience/standard-business-continuity-and-disaster-recovery.md) | BCR-01, BCR-02, BCR-03, BCR-04, BCR-05 | A.5.29, A.5.30, A.8.14 | RC.RP, RC.CO, ID.BE | — | Business continuity | §8.1 | — | IT systems backup and continuity |
| Resilience | Procedure: Backup and Recovery | [`resilience/procedure-backup-and-recovery.md`](../resilience/procedure-backup-and-recovery.md) | BCR-06, BCR-07, BCR-08, BCR-09, BCR-10, BCR-11 | A.8.13 | RC.RP | — | Business continuity | §8.1 | — | IT systems backup and continuity |
...
| Domain | Document Title | Path | CSA CCM v5 | ISO 27001:2022 | NIST CSF 2.0 | CTPAT | PIP | BASC v6 | WCO SAFE | AEO/AEO-S |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Privacy | Policy: Privacy and Data Governance | [`privacy/policy-privacy-and-data-governance.md`](../privacy/policy-privacy-and-data-governance.md) | DSP-01, DSP-02, DSP-03, DSP-04 | A.5.34, A.8.11, A.8.12 | GV.PO, PR.DS | — | Data protection | §8.4 | — | Documentation security |
| Privacy | Procedure: Privacy Impact and Cross-Border Transfer | [`privacy/procedure-privacy-impact-and-cross-border-transfer.md`](../privacy/procedure-privacy-impact-and-cross-border-transfer.md) | DSP-03, DSP-04, DSP-06 | A.5.34 | GV.PO, PR.DS, ID.RA | — | Data protection | §8.4 | — | Documentation security |

---

## Framework Coverage Summary

The following table summarises how many GRC library documents provide primary coverage per framework, to assist in identifying gaps.
...
| ISO/IEC 27001:2022 | All 42 documents | Coverage across Annex A clauses and management system clauses §4–§10 |
