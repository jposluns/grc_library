...
| Inform any individual from whom the institution collects personal information about that individual of the purpose of the collection | Act subsection 5(2) |
...
| Dispose of personal information under the control of the institution in accordance with the regulations and any directives or guidelines of the designated minister on disposal | Act subsection 6(3) |
| Without the individual's consent, use personal information under the control of the institution only for the purpose for which it was obtained or compiled, a use consistent with that purpose, or a purpose for which it may be disclosed to the institution under subsection 8(2) | Act section 7 |
| Without the individual's consent, disclose personal information under the control of the institution only in accordance with section 8 | Act subsection 8(1) |
| Include in personal information banks all personal information under the control of the institution that has been used, is being used or is available for use for an administrative purpose, or is organized or intended to be retrieved by the name of an individual or by an identifying number, symbol or other particular assigned to an individual; this does not apply to personal information transferred to the Library and Archives of Canada for historical or archival purposes | Act subsections 10(1) and 10(2) |
| Subject to the Act, give a Canadian citizen or permanent resident (within the meaning of subsection 2(1) of the Immigration and Refugee Protection Act), on request, access to personal information about that individual contained in a personal information bank, and to any other personal information about that individual under the control of a government institution where the individual provides information on its location specific enough to make it reasonably retrievable; the Governor in Council may, by order, extend this right to other individuals on conditions it sets | Act subsections 12(1) and 12(3) |
...
| The head may extend the thirty-day limit by at most thirty days where meeting it would unreasonably interfere with the operations of the institution, or where consultations necessary to comply with the request cannot reasonably be completed within it; or by a reasonable period where additional time is necessary for translation or for conversion into an alternative format. An extension is made by notice within the original thirty days that states the new time limit and the right to complain to the Privacy Commissioner | Act section 15 |
...
| Notify the Treasury Board of Canada Secretariat (TBS) and the Office of the Privacy Commissioner of Canada (OPC) of planned initiatives (legislation, regulations, policies or programs) that could relate to the Act or affect the privacy of individuals, early enough to permit review and discussion while respecting Cabinet confidences | Policy 4.2.2 |
| Prepare and update personal information banks as section 10 of the Act requires, and obtain the approval of the President of the Treasury Board to establish, modify or terminate one unless otherwise specified in the terms and conditions of a delegation under subsection 71(6) of the Act | Policy 4.2.4 and 4.2.5 |
...
| Establish plans to address privacy breaches that affect personal information under the control of the institution, including breaches that occur within third parties under contract, agreement or arrangement with it, and review the plans periodically | Policy 4.2.10 and 4.2.11 |
