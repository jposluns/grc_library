...
|---|---|---|---|
| **NIST publications** (SP 800-series, FIPS, NIST CSF) | Revision or version *and* control family or specific control ID | `NIST SP 800-53 Rev. 5 AC-2(7)`; `NIST SP 800-171 Rev. 3 03.01.05`; `NIST CSF 2.0 PR.AA-05` | `NIST 800-53`; `NIST CSF` |
| **ISO/IEC standards** | Standard number *and* year *and* clause or Annex control | `ISO/IEC 27001:2022 Annex A.5.10`; `ISO/IEC 27701:2025 Annex A.3.3`; `ISO/IEC 27017:2026 5.38` | `ISO 27001`; `ISO/IEC 27001:2022` (without clause) |
...
| **Information Security** | ISO/IEC 27001:2022, NIST CSF, sector-specific cybersecurity regulations | High |
