...
- Voice over IP (VoIP) and unified communications service providers.
- Satellite and submarine cable operators.
- Internet exchange points and top-level-domain registries.
- Data centre operators in scope of jurisdictional electronic-communications regulation.
...
| --- | --- | --- |
| [`annex-telecommunications-sector-requirements.md`](annex-telecommunications-sector-requirements.md) | Annex | Telecommunications sector regulatory landscape including jurisdiction-specific electronic communications regulations, lawful interception, emergency services, and critical infrastructure designation. |
