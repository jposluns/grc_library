...
This annex is a public-domain navigation aid. Telecoms compliance requires alignment to the national licence conditions, the regulator's published code of practice, the national security service's specific requirements for lawful access, and sector-specific incident reporting. Adopting providers consult the national regulator, their licence documentation, and specialist counsel. This annex is not legal advice and does not address national-security-sensitive obligations in detail because such obligations are typically not public.
