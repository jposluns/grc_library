...
- The reference base: the in-repo validator modules [`tools/ccm_aicm_reference.py`](../../../../tools/ccm_aicm_reference.py), [`tools/nist_csf_reference.py`](../../../../tools/nist_csf_reference.py), and [`tools/cobit_iso31000_reference.py`](../../../../tools/cobit_iso31000_reference.py) (gate-validated codes and titles) and the scratch `grc_library_scratch/ref/` full-text extracts (source control titles; the CSA catalogues under `ref/frameworks/CSA/`, the NIST CSF text under `ref/standards/NIST/`).
