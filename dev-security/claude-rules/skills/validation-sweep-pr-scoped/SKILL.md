...
- Related skill `pr-retrospective` (slash command `/retro`, queued for PR #185, will live at `dev-security/claude-rules/skills/pr-retrospective/SKILL.md`): consumes `/validate-pr` findings as input for the post-merge retrospective and improvement-log register.
