# Standard: Developer Security Requirements
...
**Related Documents:** `dev-security/standard-security-baseline-and-standards-reference.md`, `dev-security/standard-devops-security-requirements.md`, `dev-security/standard-security-quick-reference.md`, `ai/standard-ai-security-and-risk.md`  
**Classification:** Public  
**Category:** Developer Security  
**Review Frequency:** 6 to 12 months and upon material threat, tooling, or framework change  
**Repository Path:** `dev-security/standard-developer-security-requirements.md`  
