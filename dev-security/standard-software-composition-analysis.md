...
| Critical infrastructure code | SLSA Level 3 | Hardened build platform (SLSA Build L3); hermetic, reproducible builds as an organizational requirement beyond Build L3 |
...
| **SLSA Framework** | Build track levels L0 to L3 and Source track levels L1 to L4 (SLSA v1.2); build-platform, provenance, and source-control requirements |
