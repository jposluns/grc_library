...
- All containerised workloads and container images
...
| **CVE** | Common Vulnerabilities and Exposures — standardised identifiers for known vulnerabilities |
| **CVSS** | Common Vulnerability Scoring System — a numeric score (0–10) representing the severity of a vulnerability |
| **PURL** | Package URL — a standardised scheme for identifying packages across ecosystems |
...
|---|---|---|---|
| 9.0–10.0 | Critical | 7 calendar days | CISO; executive leadership |
| 7.0–8.9 | High | 30 calendar days | CISO |
| 4.0–6.9 | Medium | 90 calendar days | Security Champion |
| 0.1–3.9 | Low | 180 calendar days or at next release | Development team |
...
| **Proprietary / Commercial** | Custom commercial licences | Subject to procurement and legal review | Licence terms must be reviewed; ensure scope covers intended use |
...
|---|---|
| **Exploitability** | Is an exploit publicly known and weaponised? (EPSS score; CISA KEV catalogue) |
...
| **DevOps / Platform Team** | Maintain and configure SCA tooling in CI/CD pipelines; ensure SBOM generation is automated; manage private registry configuration |
...
| **SLSA Framework** | Build integrity levels 1–4; provenance requirements |
