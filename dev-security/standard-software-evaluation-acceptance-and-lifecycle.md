...
- Rollback and recovery plans validated in testing prior to deployment, or approved by the CAB with documented compensating controls under the change management procedure where pre-deployment testing is not operationally feasible.
