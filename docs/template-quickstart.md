...
To plan the fuller composition (what to add beyond the floor), see **[`docs/template-startup-roadmap.md`](template-startup-roadmap.md)**: the full composition workbook. Five dimensions (activity, data scope, audience, regulatory exposure, GRC capacity), 25 modules, three worked examples. Plan on an afternoon.
