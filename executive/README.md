...
applicable). It explains what the corpus governs and why it matters at the leadership level.

**This layer does not establish requirements; the linked corpus governs.** Nothing in `executive/` is a
policy, a standard, a control, a source of any obligation, or evidence that a control operates. Every
...
gate family are introduced in Phase 1); it remains fully inside the repository's safety gates (secrets,
PII, link integrity, external link domains).
