...
How the corpus establishes protective controls and the ability to withstand and recover from disruption. Supported routes: [What the governing body should require for AI resilience and continuity](briefs/brief-ai-resilience-continuity.md) (Executive Brief). [When the enterprise identity provider can no longer be trusted](scenarios/scenario-identity-provider-compromise.md) (Scenario). [When a release-signing key is compromised after software reaches production](scenarios/scenario-release-signing-key-compromise.md) (Scenario).

### 4. Data, privacy, and information lifecycle
How the corpus governs personal and sensitive information across its lifecycle. Supported routes: [What the governing body should require for AI data governance and classification](briefs/brief-ai-data-governance.md) (Executive Brief). [When a customer-data service must move after its legal operating boundary changes](scenarios/scenario-jurisdictional-data-redesign.md) (Scenario). [From retention rule to destruction evidence: the governed journey of a record](journeys/journey-record-retention-destruction.md) (Journey).
