...
- **Classification comes before use.** The [AI security and risk standard](../../ai/standard-ai-security-and-risk.md) requires that data used by an AI system is classified before use, that provenance is documented across every data class it enumerates, that lineage identifies source through to deletion method, and that sensitive data is not used unless authorized, risk-assessed, and controlled (its section 4.2).
...
- **Classification travels with the data.** The [data classification and handling standard](../../security/standard-data-classification-and-handling.md) states that AI-derived data inherits the classification of its source unless explicitly reclassified (its section 5), and the [data architecture standard](../../architecture/standard-data-architecture.md) has classification tags propagate with data through transformation and marks data unsuitable for AI prompts or training with the sensitivity designation it defines (its section 5).
...
- **Deletion propagation records**, as evidence for the deletion-propagation controls the [training data governance procedure](../../ai/procedure-training-data-governance.md) defines (its Step 6), including its recorded distinction between the deletion outcomes it treats as assured and those it treats as best-effort with documented residual exposure, and that retirement handles datasets and retrieval stores per the [AI security and risk standard](../../ai/standard-ai-security-and-risk.md) (its section 4.11).
