...
**Repository Path:** [`executive/briefs/brief-ai-production-approval.md`](brief-ai-production-approval.md)\
...
- **Production approval is a management decision.** The [AI system impact assessment procedure](../../ai/procedure-ai-system-impact-assessment.md) places the approve-or-reject decision, at its Step 9, with an accountable approving authority, and escalating it to the higher management authority the procedure names for the cases it specifies. The production gate is management's, exercised within the appetite the governing body has set.
...
- **Residual risk beyond appetite escalates above the management gate.** The [exception and risk acceptance policy](../../governance/policy-exception-and-risk-acceptance-management.md) routes acceptance of residual risk that exceeds the organization's defined appetite above a routine management approval, to the higher authority it designates (its section 4.2 sets the risk levels and the authority). Where a system would enter production carrying such risk, that acceptance follows this route rather than an ordinary production sign-off.
...
- **The risk-acceptance record**, as evidence that any residual risk carried into production beyond the organization's appetite followed the [exception and risk acceptance policy](../../governance/policy-exception-and-risk-acceptance-management.md).
