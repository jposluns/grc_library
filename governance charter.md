...
The Governance Charter defines the framework for oversight, accountability, and continual improvement of all governance instruments and decision-making bodies.  

It establishes the authority model governing frameworks, policies, standards, and procedures across information technology, information security, privacy, artificial intelligence, sustainability, risk, and compliance domains.  
...
- **Integrity:** Decisions and conduct follow legal, ethical, and professional standards.  
- **Transparency:** Governance changes and policy decisions are documented and communicated openly.  
...
|--------|-------------|----------|
| 1 | Governance Charter | Defines authority, structure, and approval process. |
| 2 | Frameworks | Provide strategic governance structure and integration. |
| 3 | Policies | Express executive intent and mandatory principles. |
| 4 | Standards | Establish measurable requirements and control baselines. |
| 5 | Procedures | Define operational execution of standards and policies. |
...
| Level | Description | Review Cycle | Approval Authority |
|--------|--------------|--------------|--------------------|
| 1 | Governance Charter | Annual | CIO |
| 2 | Frameworks | Annual | CIO |
| 3 | Policies | Annual | CIO |
| 4 | Standards | Annual | CISO |
| 5 | Procedures | Annual or as needed | CISO |
| 6 | Guidelines / Annexes | Annual or as needed | Directors / Managers |
| 7 | Registers / Matrices | Annual | CISO |
...
All governance artefacts are developed and maintained through a controlled lifecycle ensuring clarity, traceability, and alignment with organizational strategy.  

- Governance instruments must support organizational and regulatory objectives.  
- Each document must declare related frameworks, parent policies, and dependent artefacts.  
- Approved versions are stored in the GRC repository as the authoritative source.  
...
Comprehensive cross-references are maintained in:
