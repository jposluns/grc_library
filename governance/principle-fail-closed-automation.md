...
NIST SP 800-53 Rev. 5 SC-24 (Fail in Known State) is the primary reference for the known-controlled-state facet this principle expresses; IEC 61508 and IEC 61511 are the functional-safety root of the fail-safe concept the principle generalizes.
