...
| **Trust** | Accountable and Transparent ("trustworthy AI depends upon accountability; accountability presupposes transparency") | A.3 accountability; A.5 impact-assessment documentation; A.10.2 responsibility allocation | trust (3.41), trustworthiness as verifiability (3.42), accountability as traceability (3.1) | NIST SSDF PS.1; CSA CCM LOG-02, LOG-04, LOG-10, GRC-04; ISO/IEC 27001 A.8.15, A.5.36 |
...
| Integrity of work product (no fabrication, no suppression) | PW.7, PO.4.1, PO.4.2 | A&A-04 | A.5.36, A.5.33 | Accountable and Transparent | A.8 |
| Evidence-grounded accuracy | N/A | LOG-02 | A.5.36, A.8.15 | Valid and Reliable | A.6.2.4 |
| Trust warranted by an audit trail and authority-gated closure | PS.1 | LOG-02, LOG-04, LOG-10, GRC-04 | A.8.15, A.5.36 | Accountable and Transparent | A.3, A.5 |
