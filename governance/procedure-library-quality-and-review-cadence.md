...
The full 36-gate audit programme (see [`governance/specification-audit-programme.md`](specification-audit-programme.md) §6 for the canonical gate inventory) runs in CI and pre-commit; any failure blocks merge unless an explicit exception is recorded.
