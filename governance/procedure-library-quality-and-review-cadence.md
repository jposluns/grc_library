...
2. Auto-generated artefacts (taxonomy, narrative registry, portal, maturity scorecard, relationship model, and the generated `## Number allocation` block).
...
| Organization-neutrality check | The document is rechecked against the organization-neutrality rules; any residue is removed |
...
| [`narrative.yml`](../narrative.yml) | Regenerated by [`tools/build-narrative-registry.py`](../tools/build-narrative-registry.py) from `executive/` page metadata whenever narrative pages change |
...
| [`governance/relationship-model.generated.json`](relationship-model.generated.json) | Regenerated by [`tools/build-relationship-model.py`](../tools/build-relationship-model.py) from the hand-maintained source whenever the relationship model changes |
| The generated `## Number allocation` block | Regenerated by [`tools/build-todo-number-allocation.py`](../tools/build-todo-number-allocation.py) from the number floor and the live backlog ids whenever a backlog number is allocated |
...
| Relationship model in sync | `tools/build-relationship-model.py --check` | In sync |
| Number-allocation block in sync | `tools/build-todo-number-allocation.py --check` | In sync |
...
| Organization-neutrality sweep | Quarterly: an organization-neutrality spot-check across documents touched in the period |
...
| Quarterly organization-neutrality spot-check | Quarterly |
...
| Organization-neutrality | No real organization identifiers; the library remains organization-neutral |
| Language quality | The audit suite remains clean |
| Auto-generated artefacts | In sync with their authoritative sources at all times |
