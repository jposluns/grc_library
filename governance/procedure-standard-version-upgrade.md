...
| Requirement | NIST CSF 2.0 | COBIT 2019 | ISO 9001 |
| --- | --- | --- | --- |
| Controlled change to referenced requirements | GV.OC, GV.PO | APO01, MEA03 | §7.5, §8.5.6 |
| Documented-information currency | GV.OC | BAI08 | §7.5.3 |
| Verification against an authoritative source | GV.OV | MEA01 | §9.1 |
