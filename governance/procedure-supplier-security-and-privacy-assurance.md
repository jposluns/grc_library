...
This procedure defines the security, privacy, and trade-compliance assurance process for suppliers, vendors, and service providers that handle, process, or transmit organisational, personal, or trade data.

---

## Purpose

To ensure that all third parties meet the organisation's technical, privacy, and regulatory standards before engagement and throughout the supplier relationship lifecycle, including ISO/IEC 27001, ISO/IEC 27701, ISO 28000, BASC International Standard v6, and WCO SAFE requirements.
...
3. Applies to suppliers handling organisational or customer data, personal data subject to privacy laws, trade and customs data regulated under BASC and WCO SAFE, and AI model or dataset services.
...
| **Procurement and Legal** | Ensure contractual clauses align with security, privacy, and BASC trade-security obligations. |
...
Procurement shall not finalise vendor selection until:
...
| **Incident notification** | Notification to the organisation within 24 hours of any breach or suspected compromise affecting organisational data. |
...
| Return or securely destroy all organisational data | 30 days |
...
| Termination and offboarding | A.5.20 | §7.3.7 | APO10.05 | STA-06 | — |
| Breach coordination | A.5.24–5.28 | §8.9 | DSS02 | SEF-02 | GDPR Art. 33 |
