...
| AI model routing and selection governance | Partial | Out of scope | n/a | Model-selection and tiered-routing are addressed by shipped standards ([`standard-ai-inference-cost-governance.md`](../ai/standard-ai-inference-cost-governance.md) records model-selection rationale and cheaper-model/tiered-routing fallback; [`standard-ai-access-and-agent-permissions.md`](../ai/standard-ai-access-and-agent-permissions.md) records routing decisions with the chosen model and rationale; model selection is an ADR); dedicated routing/selection governance (consolidated selection criteria, fallback-quality governance, routing auditability) remains the gap. Assessed 2026-08-03 (2.30) and dedicated build declined as a durable, revisitable decision |
| AI batch inference governance | Partial | Out of scope | n/a | Provider batch-API usage is addressed operationally in [`standard-ai-inference-cost-governance.md`](../ai/standard-ai-inference-cost-governance.md) (batch APIs for non-interactive workloads); dedicated batch-inference governance (scheduling, cost/latency SLOs, failure handling) remains the gap. Assessed 2026-08-03 (2.30) and dedicated build declined (durable, revisitable) |
| Self-hosted model serving architecture | Partial | Out of scope | n/a | Self-hosted models are addressed in shipped documents ([`procedure-foundation-model-lifecycle.md`](../ai/procedure-foundation-model-lifecycle.md) secure-hosting plan; [`standard-ai-inference-cost-governance.md`](../ai/standard-ai-inference-cost-governance.md) self-hosted hosting cost; [`standard-ai-and-agentic-development-security.md`](../ai/standard-ai-and-agentic-development-security.md) self-hosted security review); a dedicated serving architecture (serving, capacity, and isolation model) remains the gap. Assessed 2026-08-03 (2.30) and dedicated build declined (durable, revisitable) |
| AI use-case portfolio schema | Partial | Out of scope | n/a | Idea-stage governance exists ([`framework-ai-value-and-decision-governance.md`](../ai/framework-ai-value-and-decision-governance.md)) and the AI System Register ([`template-ai-system-register.md`](../ai/template-ai-system-register.md)) already admits proposed use cases (Business Purpose, Lifecycle Status of Proposed); a fuller opportunity-portfolio and value-hypothesis schema remains the gap. Assessed 2026-08-03 (2.30) and dedicated build declined (durable, revisitable) |
