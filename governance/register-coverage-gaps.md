...
The `ai/jurisdictions/` structure (parallel to `privacy/jurisdictions/`) was founded by the EU AI Act annex and now holds eleven dedicated annexes: Australia, Canada, the European Union, Singapore, South Korea, US California (CCPA ADMT), US Colorado, US federal (OMB memoranda), US Illinois, US New York City, and US Texas. The remaining candidates below are source-gated or awaiting an annex; see the TODO backlog's AI-jurisdiction-overlays item for the candidate list and its further-AI-jurisdiction-annexes item for the deferred set.
...
| US federal (executive branch) | Substantive | In library | n/a | Dedicated jurisdiction annex [`ai/jurisdictions/annex-ai-us-federal.md`](../ai/jurisdictions/annex-ai-us-federal.md) (OMB M-25-21 agency AI governance and high-impact minimum practices, M-25-22 AI acquisition contract terms, M-26-04 Unbiased AI Principles in LLM contracts; binding on agencies, reaching vendors through contracts), with America's AI Action Plan (July 2025) as strategy context |
