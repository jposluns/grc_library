...
| Semantic layer and business-definition governance | None | Planned | TODO backlog: semantic layer and business-definition governance standard | Row added 2026-09-25 (external review): the lifecycle governance of shared business definitions, glossary terms, ontologies and metric definitions that centralized context and semantic layers (including AI retrieval context) depend on: ownership, change control, versioning and cross-domain reconciliation. Adjacent controls exist but do not cover this lifecycle: data stewards maintain data dictionaries ([`privacy/policy-privacy-and-data-governance.md`](../privacy/policy-privacy-and-data-governance.md)), reference and master data are centrally curated with versioned hierarchies ([`architecture/standard-data-architecture.md`](../architecture/standard-data-architecture.md)), and metric registers require an owner and a measurement or interpretation rule per metric |
