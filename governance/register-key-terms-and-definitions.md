...
| AI System | A system that uses machine learning, rules, statistical methods, retrieval, generation, automation, or decision logic to produce outputs that affect business, security, operational, legal, or human outcomes. |
...
| Third Party | An external provider, contractor, supplier, processor, platform, data provider, model provider, integrator, or service operator. |
