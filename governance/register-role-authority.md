...
| Data Protection Officer | Privacy governance, personal data protection, impact assessments, and data subject rights. **Canonical library term** for the privacy-lead role (the acronym "DPO" is defined in [`register-glossary.md`](register-glossary.md)), following the statutorily-mandated title in GDPR Article 37, LGPD Article 41, India DPDP Act 2023 §10, Malaysia PDPA (as amended by Act A1727), and similar regimes. **Adopter substitutions**: organisations using "Chief Privacy Officer" / "CPO" (typically Canada and the United States) substitute that title throughout their fork; organisations maintaining both DPO and CPO as distinct roles (e.g., DPO regulatory-facing, CPO strategic / executive) add a separate CPO row to this register reflecting the separation. The accountability set defined here applies to whichever title the adopter chooses. | Privacy policy, impact assessment procedure, breach response procedure. |
