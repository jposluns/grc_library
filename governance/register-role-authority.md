...
| Approve exception | Tiered by risk level per [`governance/policy-exception-and-risk-acceptance-management.md`](policy-exception-and-risk-acceptance-management.md) §4.2.2 and §4.3.5, which are authoritative for the complete chain (summary, not exhaustive: Department Head for low; CIO or delegate for medium; Executive Committee or Board Risk Committee for high or critical; the CISO co-approves any security-related exception; trade or customs-related exceptions add applicable compliance-officer co-approval and ERC notification; renewals escalate to the original approver for the first, the ERC for the second, and the Board Risk Committee for the third and final, per §4.3.5) | Request Owner | Legal, Security, Privacy, Compliance | Control Owner, Audit where applicable |
