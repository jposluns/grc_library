...
| Approve exception | Tiered by risk level per [`governance/policy-exception-and-risk-acceptance-management.md`](policy-exception-and-risk-acceptance-management.md) §4.2.2 (Department Head for low; CIO or delegate for medium; Executive Committee or Board Risk Committee for high or critical; the ERC approves the second renewal and the Board Risk Committee approves the third and final renewal, see §4.3.5; and the CISO co-approves any security-related exception) | Request Owner | Legal, Security, Privacy, Compliance | Control Owner, Audit where applicable |
