...
- **The source texts are proprietary or licence-restricted and are NOT redistributed in this corpus.** The `grc_library_ref` base is the maintainer's own licensed holding; do not copy source text into corpus documents (cite the metadata and the requirement, not the copyrighted body).
