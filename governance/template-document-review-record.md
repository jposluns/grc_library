...
This template is a public-domain baseline. The specific layout, tooling, and storage location for review records are organisation-specific. The template expresses the minimum content and the cadence integration; adopting organisations adapt the surface form to their tooling.
