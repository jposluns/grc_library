...
Aggregated output of the ten automated audits:
...
This template is a public-domain baseline. The specific report contents, the audience, the publication mechanism, and the integration with adjacent reports are organisation-specific. The library itself uses this template to produce its own quarterly health reports.
