...
| --- | --- | --- | --- | --- |
| No bypass of security gates | V15 | PW.7.2 | CCC-03, CCC-04 | A.8.28 |
| Documented exceptions to controls | V15.1 | PO.4.1 | GRC-04 | A.5.4 |
| Gate-effectiveness review | V15.1 | PO.4.1 | GRC-05 | A.5.36 |
| Change-management for control modifications | V15.1 | PO.4.1 | CCC-01 to 03 | A.5.4 |
