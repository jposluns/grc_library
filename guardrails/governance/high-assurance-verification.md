...
| Adversarial review proportional to risk | PO.5 | GRC-04, GRC-05 | A.5.4, A.5.35 | V15.1 |
| Deterministic, repeatable apply (no ad-hoc hand edit) | PO.5, PW.4 | CCC-01 to 04 | A.8.32 | V15 |
| Findings and verifications traceable to a record | PS.1 | LOG-02, LOG-04, LOG-10 | A.8.15, A.5.36 | V16.2, V16.4 |
