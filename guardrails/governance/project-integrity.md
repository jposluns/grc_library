...
- **Quality.** The work meets the standard the project sets for craft: correct against requirements, consistent with the project's conventions, complete across every paired surface a change touches. Enforced by the consuming project's audit programme and its QA cadences (per-change sweeps, periodic project-wide sweeps, and the skeptical-verifier tiers in [`ai-assistant-workflow-disciplines.md`](ai-assistant-workflow-disciplines.md)). Quality also requires proportionality: after the stated requirements, security controls, and required defence in depth are satisfied, prefer the smallest correct change. Every new abstraction, dependency, and adjacent refactor must earn its complexity; do not expand scope or remove controls merely to reduce line count.
...
| --- | --- | --- | --- | --- |
| Quality prioritized over schedule and cost | N/A | GRC-01, GRC-04 | A.5.1, A.5.4 | V15.1 |
| Integrity of work product (no fabrication, no suppression) | PW.7.2 | GRC-05, A&A-04 | A.5.36, A.5.33 | V15 |
| Escalation of authority-bound tradeoffs | N/A | GRC-04 | A.5.4 | V15.1 |
| Failing states surfaced, not concealed | N/A | LOG-02, GRC-05 | A.8.15, A.5.36 | V16.2 |
