...
- Canonical rule [`governance/action-before-explanation-of-inaction.md`](../../governance/action-before-explanation-of-inaction.md): framework alignment (NIST SSDF PO.5; CSA CCM GRC-04 / GRC-05 / LOG-02; ISO 27001 Annex A.5.4 / A.5.18 / A.5.36 / A.8.15; OWASP ASVS V15.1 / V16.2), exception-handling protocol, and the discussion of why an AI coding assistant is the dominant target of this discipline.
