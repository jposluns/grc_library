...
- Canonical rule [`governance/change-tracking.md`](../../governance/change-tracking.md): the full discipline, the three CI gates that implement it (delta gate, link-coverage gate, version-monotonicity gate), monorepo coordination, generated-CHANGELOG workflows, document-corpus conventions, framework alignment (NIST SSDF PO.5 / PS.1 / PS.3, CSA CCM CCC-01 to 03 / LOG-02 / LOG-04 / LOG-10 / CCC-04, ISO 27001 Annex A.5.4 / A.8.32 / A.8.15 / A.8.27), and the exception-handling protocol for embargoed or deferred entries.
