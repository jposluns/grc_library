...
13.2.1 Every approved and implemented change updates the affected component's configuration baseline. The [`OT Asset Inventory and Lifecycle Register`](register-ot-asset-inventory-and-lifecycle.md) is the canonical source of baselines.
