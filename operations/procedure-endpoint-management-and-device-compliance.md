...
| --- | --- |
| Solid-state drives (SSD) | IEEE 2883 Purge via Cryptographic Erase or Sanitize Block Erase |
...
| Configuration compliance and hardening | A.8.9 | SP 800-124 Rev. 2 §5.3.3 Set Policy, Device Configuration, and Provision | UEM-05, UEM-02 | DSS05.03 |
...
| Patch and vulnerability management | A.8.8 | SP 800-124 Rev. 2 §4.3.6 Rapid Adoption of Software Updates | UEM-07, TVM-03, TVM-08 | DSS05.07 |
