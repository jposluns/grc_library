...
| Patch testing | SP 800-40r4 §2.3.1 (Prepare to deploy the patch) | A.8.8 | TVM-08 | Control 7.4 | BAI07.03, BAI07.04, BAI07.05 |
...
| EOL lifecycle management | SP 800-40r4 §3.5.4 (Maintenance plans for Scenario 4, unpatchable assets) | A.8.8 | TVM-01, TVM-08 | 2.2 | BAI09.03, DSS05.07 |
| Third-party / library patching | SP 800-40r4 §3.7 (Consider software maintenance in procurement) | A.8.8 | TVM-08 | 16.4, 16.5, 7.7 | DSS05.07 |
