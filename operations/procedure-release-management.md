...
This procedure is a public-domain baseline. Release practice is highly tooling-dependent; the procedure expresses requirements rather than vendor-specific implementations. Adopting organisations confirm current tooling and select deployment strategies appropriate to their architecture.
