...
### 4.2 Pre-go-live security validation
...
## 7. Infrastructure programme security gate requirements
...
| Security baseline sign-off | GO/NO-GO gate before production | All items in §4.2 evidenced; segmentation validated; SIEM ingestion confirmed; PAM workflow validated; backup immutability validated; break-glass accounts tested |
...
## 10. On-premises middleware security
...
### 10.1 Service account isolation
...
### 10.4 Partner and certificate management
...
### 10.7 Migration to cloud integration platforms
...
- For on-premises systems (database servers, OS, middleware): upgrade plans must be initiated at the 180-day pre-EOL milestone. Runtimes graded Class 1 (Critical) under the baseline EOL risk-severity classification (more than 12 months past EOL with a CVSS 7.0-or-above CVE since EOL) must be on emergency remediation with monthly status reported to the CIO.
...
| Monitoring and incident response | A.8.15 to 8.16, A.5.24 to 5.28 | LOG-01 to LOG-07, LOG-09 to LOG-14, SEF-01 to 10 | IR-4 to IR-6, SI-4 | N/A |
| Vulnerability management | A.8.8 | TVM-03 to 12 | RA-5, SI-2 | RV.1, RV.2 |
...
| EOL and lifecycle | A.8.8 | TVM-01 | SA-22 | PW.4.4, RV.2.1, RV.2.2 |
