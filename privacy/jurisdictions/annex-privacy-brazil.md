...
- **Lawful basis (Article 7):** processing requires one of the ten lawful bases, including consent, legitimate interest, contract performance, legal obligation, and studies by a research body with anonymization wherever possible (Art. 7(IV)).
- **Sensitive personal data (Article 11):** processing of the Article 5(II) sensitive categories, namely racial or ethnic origin, religious conviction, political opinion, trade-union or religious/philosophical/political-organization membership, data concerning health or sex life, and genetic or biometric data linked to a natural person, requires consent (specific and in evidence) or another specific Article 11 basis. Children's and adolescents' data are governed separately by Article 14: all such processing must be in their best interest, and processing of a child's data generally requires specific and highlighted consent from at least one parent or the legal guardian (Art. 14 paragraph 1), subject to the limited paragraph 3 exceptions.
...
- **Data Protection Officer (DPO) (Article 41):** controllers designate a DPO (Encarregado) and publish the contact details, except that eligible small-scale processing agents (Agentes de Tratamento de Pequeno Porte) are not required to designate an encarregado (ANPD Resolution CD/ANPD No. 2/2022, Art. 11), subject to the Art. 3 exclusions (high-risk or over-threshold agents) and the ANPD's Art. 16 discretion to require the obligation; an eligible agent that does not designate one provides a communication channel with data subjects (Resolution CD/ANPD No. 18/2024, Art. 3 paragraph 3). Resolution CD/ANPD No. 18/2024 (of 16 July 2024, the Regulation on the activities of the encarregado) is the ANPD rule operationalizing the appointment, definition, attributions, and performance of the encarregado under LGPD Article 41: who may serve, how the designation is formalized, conflict-of-interest limits, whether a legal entity may serve, and when a substitute is required. (Resolution CD/ANPD No. 18/2024 was verified against the ANPD's official regulations publication on 2026-07-13, confirming the 16 July 2024 enactment and the 17 July 2024 Diário Oficial da União publication; it remains in force with no amendment.)
...
- **ANPD and AI (2024 to 2025):** the LGPD's requirements (a lawful basis, data minimization, purpose limitation) apply to AI training on personal data; no ANPD AI-guidance instrument is held in the reference base, so an adopter confirms the current ANPD position directly.
...
5. **Derogations (Article 33, items IV, VIII, IX):** Transfers made with the data subject's specific and highlighted consent (item VIII), necessary to protect the life or physical safety of the data subject or a third party (item IV), or necessary to satisfy a legal obligation, contract, or the regular exercise of rights in judicial, administrative, or arbitral proceedings under Article 7 (item IX).
