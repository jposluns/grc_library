...
- **Artificial Intelligence and Data Act (AIDA)**: Was Part 3 of Bill C-27. AIDA also lapsed with Bill C-27 at the January 2025 prorogation and, per a June 2025 ministerial statement not held in the reference base, is reported not to return in its original form (an adopter confirms the current position directly). The proposed framework would have regulated high-impact AI systems, requiring an assessment of whether a system was high-impact, risk mitigation measures, transparency, and mandatory harm reporting.
...
- **Privacy Act**: R.S.C. 1985, c. P-21. Federal PUBLIC-sector privacy law governing personal information held by federal government institutions (distinct from PIPEDA, which governs the private sector). The President of the Treasury Board is the designated Minister under subsection 3.1(1) responsible for establishing policies and prescribing forms concerning the operation of the Act (TBS Policy on Privacy Protection, sections 2.1 and 2.2), and the same policy records the Minister of Justice as designated Minister for certain other provisions (section 5.5); the Privacy Commissioner of Canada, appointed under section 53, receives and investigates complaints (section 29).
...
- **Regulatory authorities:** Office of the Privacy Commissioner of Canada (OPC) under PIPEDA and the Privacy Act; the order-making Privacy Commissioner that the lapsed CPPA proposed (not in force); Commission d'accès à l'information (CAI) for Quebec Law 25.
...
Where the organization monitors the network and device activity of workers in Canada, which privacy law governs the employee personal information depends on how the employer is regulated. The monitoring is governed operationally by the Workforce Network Monitoring Policy ([`security/policy-workforce-network-monitoring.md`](../../security/policy-workforce-network-monitoring.md)) and its supporting suite; the applicable statutory regime is determined as follows.

- **Federal PIPEDA covers employee data only for federally regulated works, undertakings, and businesses.** PIPEDA applies to personal information about an employee or applicant only where it is collected, used, or disclosed in connection with the operation of a federal work, undertaking, or business (s. 4(1)). For a federally regulated employer, PIPEDA governs workforce monitoring of employee data: the processing must meet the appropriateness standard (a reasonable person would consider the purposes appropriate, s. 5(3)), and s. 7.3 permits the collection, use, and disclosure of employee personal information without consent where it is necessary to establish, manage, or terminate the employment relationship and the individual has been informed in advance; PIPEDA's consent, accountability, purpose-limitation, and safeguards obligations otherwise apply where s. 7.3 or another exception does not.
- **Provincially regulated employers' employee data falls outside federal PIPEDA and is governed by provincial private-sector law where one exists.** For an employer that is not a federal work, undertaking, or business, employee personal information is outside PIPEDA's employee-data scope and is governed by the applicable provincial private-sector privacy law: British Columbia's PIPA, Alberta's PIPA, and Quebec's Law 25 each cover employee personal information. In provinces without a general private-sector privacy statute covering employee data, there may be no comprehensive statutory privacy regime for such monitoring, and other sources (employment standards, collective agreements, common-law reasonable-expectation and tort principles) apply instead. Adopters confirm the regulatory character of each employing entity and the province before selecting the governing regime.
- **Provincially regulated employee data falls outside the PIPEDA-based EU adequacy decision.** The EU adequacy decision for Canada covers personal data subject to PIPEDA. Because employee personal information of provincially regulated employers is outside PIPEDA's scope entirely, it is not covered by that adequacy decision, so an EU-to-Canada transfer of such workforce-monitoring data cannot rely on Canadian adequacy and requires a separate Chapter V transfer mechanism. The precise material scope of the adequacy decision (which is not reproduced in the reference base) is confirmed by adopters and is not expanded categorically here.
- **Quebec Law 25 pre-transfer privacy impact assessment.** Where monitored employee data of Quebec workers is communicated outside Quebec, Law 25 requires a privacy impact assessment establishing that the information would receive adequate protection before the transfer proceeds (s. 17), and the transfer must be governed by a written agreement that takes the assessment into account. Law 25 also requires transparency about automated decisions (s. 12.1) and, at collection, notice of the possibility of communication outside Quebec (s. 8).
- **Consultation, notice, and automated decisions.** Where a representative-body or collective-bargaining duty applies to introducing monitoring, it is determined and evidenced through the [Works Council and Employee Representative Consultation Procedure](../procedure-works-council-and-employee-representative-consultation.md). Advance notice of the nature, purpose, and scope of monitoring is provided using the [Employee Monitoring Notice Template](../template-employee-monitoring-notice.md); the legitimate-interest-style balancing (relevant under BC/AB PIPA reasonableness and Law 25) is worked in the [Legitimate Interest Assessment for Employment Monitoring Annex](../annex-legitimate-interest-employment-monitoring.md); and monitoring signals do not drive automated employment decisions. Connection metadata is governed by the [Network Telemetry and DPI Controls Standard](../standard-network-telemetry-and-dpi-controls.md) and presence signals by the [Presence Inference Limitations Standard](../standard-presence-inference-limitations.md).
