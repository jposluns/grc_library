...
- **Digital Personal Data Protection Rules 2025**: Draft published by the Ministry of Electronics and Information Technology (MeitY) in January 2025 for public consultation; final Rules notified by MeitY on 13 November 2025. The Act's commencement was exercised by notification G.S.R. 843(E) of 13 November 2025, which brought it into force in three tranches under s. 1(2): the definitions and the establishment of the Data Protection Board took effect on that date; a further tranche, including the consent-manager registration duty, follows one year later (around 13 November 2026); and the core substantive regime, the consent requirements, the Data Principal rights, the Significant-Data-Fiduciary duties, and the Board's principal inquiry-and-penalty functions, commences eighteen months after publication (around 13 May 2027). The 2025 Rules (G.S.R. 846(E)) commence on their own matching schedule (rule 1(2) to (4)): rules 1, 2, and 17 to 21 on publication, rule 4 (consent-manager registration) at twelve months, and rules 3, 5 to 16, plus the procedural rules 22 and 23, at eighteen months. Most of the substantive regime, and the Board's enforcement powers, are therefore not enforceable until around May 2027; the present-tense obligations described in this annex are the regime adopters should build toward, and they should plan compliance programmes against this staged timeline rather than treat all obligations as effective on a single date.
