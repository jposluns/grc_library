...
| **Commercial use of data (s. 37)**: personal data obtained under the Act may be used for commercial purposes only with the data subject's express consent, or where written law authorizes it and the data subject was informed of that use when the data was collected from them; a controller or processor using personal data commercially must, where possible, anonymize it so the data subject is no longer identifiable. | adopter maps to library consent and data-minimization controls |
