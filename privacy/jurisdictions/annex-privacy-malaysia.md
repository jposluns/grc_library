...
| --- | --- |
| **General Principle (s. 6)**: non-sensitive personal data is processed only with the data subject's consent (s. 6(1)(a)) or, notwithstanding consent, where a s. 6(2) ground applies (contract performance, pre-contractual steps, legal obligation, vital interests, administration of justice, statutory functions); sensitive personal data is instead governed by s. 40 (s. 6(1)(b)); all processing must be for a lawful purpose directly related to the controller's activity, necessary for or directly related to that purpose, and adequate but not excessive (s. 6(3)). | library consent-management, lawful-basis, and data-minimization controls |
| **Notice and Choice Principle (s. 7)**: written notice of the processing, the data, its purposes and source, access and correction rights, contact points, classes of third-party recipients, the choices for limiting processing, and whether supply is obligatory with the consequences of failure (s. 7(1)); given as soon as practicable when the data subject is first asked to provide the data or when the controller first collects it, and, in any other case, before a new-purpose use or a third-party disclosure (s. 7(2)); in the national and English languages with a clear, readily accessible means to exercise choice (s. 7(3)). | library collection-notice and transparency controls |
