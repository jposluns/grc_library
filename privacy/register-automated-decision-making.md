...
This register is a public-domain structural baseline. Adopting organisations must populate the schema with real systems, validate Article 22 threshold determinations with legal counsel, and integrate the register with the AI System Register and the DPIA workflow. The register is not legal advice.
