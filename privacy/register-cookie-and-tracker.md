...
| Other | Any technology that does not fit the above categories | Default to prior consent required pending Privacy Officer review |
...
1. **No tracker without a register entry.** New marketing pixels, analytics tags, third-party SDKs, or fingerprinting techniques cannot be deployed without an entry in this register and a Privacy Officer review.
...
5. **Quarterly tag scan.** The Privacy Officer commissions a quarterly automated scan of the website and mobile applications to detect undeclared trackers. Drift between the scan output and the register is treated as a defect and remediated.
