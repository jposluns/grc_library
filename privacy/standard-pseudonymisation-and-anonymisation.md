...
2. Selection of pseudonymisation or anonymisation is recorded with the rationale; downgrading from anonymisation to pseudonymisation requires explicit Privacy Officer approval.
3. The technique combination is chosen by the Privacy Officer with cryptographic input from the CISO where keys are involved.
...
1. For any release outside the original processing boundary, the Privacy Officer commissions a re-identification risk assessment.
...
2. Where models are released, the Privacy Officer assesses model-inversion and membership-inference risk; release is conditional on the assessment outcome.
...
| --- | --- | --- |
| Negligible | Re-identification not reasonably likely by any party using reasonably available means; quantitative re-identification risk below 0.1% | Open release acceptable subject to Privacy Officer sign-off |
...
The percentages above are default thresholds. Adopting organisations may tighten these thresholds; loosening requires Privacy Officer and CISO joint approval.

---

## Operating expectations

1. The Privacy Officer maintains a register of pseudonymisation and anonymisation use cases with their technique, parameters, residual risk classification, and last review date.
...
| EDPB Opinion 05/2014 | Anonymisation techniques | EU regulator guidance |
