...
Completed crisis contact directories, internal recovery runbooks, infrastructure diagrams, supplier escalation paths, system-specific recovery steps, incident records, and audit evidence must not be published in this directory. Public CC BY-SA 4.0 content must remain generic, role-based, and non-identifying.
