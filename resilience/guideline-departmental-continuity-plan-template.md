...
**Related Documents:** `resilience/framework-business-continuity-and-resilience.md`, `resilience/policy-business-continuity-and-disaster-recovery.md`, `resilience/standard-business-continuity-and-disaster-recovery.md`, `resilience/procedure-business-impact-analysis.md`, `resilience/procedure-continuity-and-recovery-testing.md`, `resilience/business-continuity-and-crisis-management.md`
...
**Confidentiality:** Public template only. Completed continuity plans may contain restricted internal information.
...
5. Public CC0 examples must remain generic and non-identifying.
...
This template is a public-domain baseline. Completed departmental continuity plans can contain sensitive operational dependencies and should not be published under CC0 without sanitization.
