...
Maintain test plans, execution records, screenshots or logs where appropriate for internal use, validation results, communications records, supplier evidence, corrective action logs, and approval records. Public CC BY-SA 4.0 templates must not include internal screenshots, system names, supplier names, contact details, or operational evidence.
