...
**Related Documents:** `resilience/framework-business-continuity-and-resilience.md`, `resilience/policy-business-continuity-and-disaster-recovery.md`, `resilience/business-continuity-and-crisis-management.md`, `resilience/procedure-business-impact-analysis.md`, `resilience/procedure-continuity-and-recovery-testing.md`, `resilience/sop-backup-and-recovery-asr-for-vmware.md`
