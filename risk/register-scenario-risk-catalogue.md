...
This catalogue is a public-domain baseline. Adopting organisations curate scenarios to their threat environment, regulatory expectations, sector profile, and customer base. The scenarios listed are illustrative and not exhaustive; new scenarios are added as the threat and business environment evolves.
