...
- IT personnel will never ask for remote access to a device via the collaboration platform.
- Messages from external tenants must be treated with caution.
- Requests for screen shares, remote access, or credential sharing via the collaboration platform must be verified by calling the IT service desk directly before complying.
- Any suspicious collaboration platform interaction must be reported immediately to IT Security.
...
Violations of this policy are subject to disciplinary action up to and including termination of employment or contract. Serious violations involving criminal conduct will be reported to law enforcement. All violations are handled in accordance with the Security Disciplinary Process Procedure and the applicable HR disciplinary framework.

---

## 9. Acknowledgement

All personnel must sign or electronically acknowledge this policy upon hire and annually thereafter. Acknowledgement records are maintained in the HR management system and learning management system (LMS). Refusal to acknowledge constitutes a policy violation.
...
| COBIT 2019 | APO01.08: Define target skills and competencies |
