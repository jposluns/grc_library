...
Each security vendor or service partner is assigned a short tag (2–4 characters) used as the prefix in incident ticket names. Vendor tags are maintained by the CISO and reviewed annually.
...
| --- | --- | --- |
| **Vendor Tag** | 2–4 character code identifying the reporting vendor or service | `MDR`, `EDR`, `SOC` |
...
All security incident tickets must be created in the ITSM portal before escalation to management. Verbal or informal reports must be formalised in the ITSM portal within 1 hour for P1/P2 incidents and within 4 hours for P3/P4 incidents.
