...
| --- | --- | --- | --- | --- | --- |
| Design-time threat analysis | PW.1, PW.2 | SA-11, SA-15 | A.8.25, A.8.27 | V15.1 | AIS-04, TVM-04 |
| Documented data-flow diagrams | PW.1 | SA-15 | A.8.27 | V15.1 | TVM-04 |
| Boundary-level control mapping | PW.1, PW.2 | SA-8, SA-11 | A.8.27 | V15.2 | IAM-15 |
| AI / model-output boundary in scope | PW.1 | SA-11 | A.8.27 (secure architecture and engineering) | V15.2 | AIS-04 |
| Abuse-case authoring | PW.1 | SA-11 | A.8.27 | V15.1 | TVM-04 |
| Privacy threat modelling (LINDDUN) | PO.1, PW.1 | RA-3, SA-8 | A.5.34 | V15.1 | DSP-08 |
