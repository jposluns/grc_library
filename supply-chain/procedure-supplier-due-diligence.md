...
| Role | Responsibility |
| --- | --- |
| Chief Information Officer | Approves the supplier due diligence framework and ensures integration with risk management processes. |
...
| Procurement Director | Administers supplier assessments, manages onboarding processes, and ensures contract compliance. |
...
Regional Compliance Officers must maintain a BASC Supplier Compliance Log that is synchronised with the global Supplier Risk Register at least quarterly.
...
- COBIT 2025 BAI05 — Managed Organisational Change.
