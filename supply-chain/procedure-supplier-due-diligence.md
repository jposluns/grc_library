...
This procedure is aligned with ISO/IEC 27036-2, COBIT 2019 APO10, and CSA CCM v4.1 STA-01. Sector-specific framework alignments (for example, BASC International Standard v6 2022 for trade and logistics suppliers) apply where the organization participates in a covered programme; see [`compliance/`](../compliance/).
...
- Applicable security certifications (for example, ISO/IEC 27001:2022, SOC 2; plus sector-specific certifications such as BASC where the supplier is in scope of a covered programme, per [`compliance/`](../compliance/)).
...
| Business Continuity | Recovery capabilities, resilience planning, dependency management. | ISO 22301:2019, COBIT DSS04. |
