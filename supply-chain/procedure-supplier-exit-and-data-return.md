...
| **Chief Privacy Officer** | Oversees data return and deletion; confirms personal data obligations met |
...
| 1.5 Notify internal stakeholders: IT, Finance, Operations, Chief Privacy Officer, HR where relevant | Contract Owner / Supplier Risk Manager | Within 3 business days of decision |
...
| 2.2 Document data held by the supplier: data types, volumes, formats, storage locations | Chief Privacy Officer / IT Operations | Within 5 business days |
| 2.3 Confirm data portability requirements: format and timeline for data return | Chief Privacy Officer / Legal | Early in exit planning |
...
| 2.7 For cloud or SaaS suppliers: apply [`supply-chain/standard-cloud-exit-and-data-portability.md`](standard-cloud-exit-and-data-portability.md) requirements | IT Operations / Chief Privacy Officer | During planning |
...
| Action | Responsible | Timeframe |
|---|---|---|
| 3.1 Request the supplier to export all organisation data in the agreed format and by the agreed deadline | Supplier Risk Manager / Chief Privacy Officer | Per contract data return provision |
| 3.2 Verify completeness of returned data against the data inventory compiled in Step 2 | Chief Privacy Officer / IT Operations | Within 5 business days of receipt |
...
| 3.5 For personal data: confirm the returned data includes all personal data categories identified in the DPA | Chief Privacy Officer | Within 5 business days |
| 3.6 Escalate to Legal if supplier fails to return data within the contractual deadline | Legal / Chief Privacy Officer | Immediately on deadline breach |

### Step 4: Supplier data deletion

| Action | Responsible | Timeframe |
|---|---|---|
| 4.1 Issue formal instruction to the supplier to securely delete all copies of organisation data (including personal data, test data, backup data) | Chief Privacy Officer / Legal | Upon data return completion or at contract end |
| 4.2 Request a written deletion certificate from the supplier confirming all data has been deleted | Chief Privacy Officer / Supplier Risk Manager | Within 30 days of deletion instruction |
| 4.3 For personal data: confirm deletion complies with DPA deletion obligations (GDPR Article 28(3)(g); UK GDPR) | Chief Privacy Officer | Upon receipt of deletion certificate |
| 4.4 Where deletion certificate cannot be obtained: document the gap and risk; escalate to Chief Privacy Officer | Chief Privacy Officer | If not received within 30 days |
| 4.5 Retain deletion certificate per [`governance/register-data-retention-schedule.md`](../governance/register-data-retention-schedule.md) | Chief Privacy Officer / Legal | Permanent retention recommended |
...
| 6.5 Remove supplier from subprocessor register if applicable: [`supply-chain/register-subprocessor-template.md`](register-subprocessor-template.md) | Chief Privacy Officer | Within 5 business days |
| 6.6 Notify affected data subjects if required by applicable law (e.g., change in data processor) | Chief Privacy Officer / Legal | Per regulatory obligation |
