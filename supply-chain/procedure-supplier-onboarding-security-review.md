...
| **Legal / Procurement** | Reviews and executes contractual requirements; ensures DPA where applicable |
...
| 1.3 Classify the supplier into Tier 1–4 using criteria in [`risk/standard-third-party-and-supply-chain-risk.md`](../risk/standard-third-party-and-supply-chain-risk.md) | Supplier Risk Manager | Within 2 business days |
...
| Action | Responsible | Timeframe |
|---|---|---|
| 5.1 Access provisioning gate check — confirm Steps 1–4 are complete before access is granted | Supplier Risk Manager | Before any access |
...
| **Gate 5 — Access** | Have all gates 1–4 been passed? | Access may be provisioned only after all gates passed |
