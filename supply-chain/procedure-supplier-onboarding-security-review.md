...
| 2.2 Request supporting evidence as required by tier (ISO/IEC 27001:2022 certificate; SOC 2 report; pen test attestation; etc.): see [`supply-chain/standard-supplier-security-and-privacy-assurance.md`](standard-supplier-security-and-privacy-assurance.md) | Supplier Risk Manager | With questionnaire |
