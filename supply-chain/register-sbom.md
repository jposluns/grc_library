...
This register is a public-domain structural baseline. SBOM coverage is bounded by the producer's ability and willingness to generate accurate, complete artefacts; transitive dependency visibility decreases with sub-tier supplier maturity. The register supports vulnerability and supply-chain integrity programmes but does not itself remediate vulnerabilities or attest to product security.
