...
| 1.5 Describe the services you provide to the Organization | |
| 1.6 What countries and regions will you process or store the Organization's data in? | |
...
| 7.4 Are you willing to sign a Data Processing Agreement (DPA) with the Organization? | | |
...
| 8.3 What are your target Recovery Time Objective (RTO) and Recovery Point Objective (RPO) for services provided to the Organization? | | |
...
| Question | Yes/No | Evidence / Comment |
|---|---|---|
| 9.1 Will you use sub-contractors to deliver services to the Organization? | | |
...
| 9.5 Will any sub-contractors process personal data on behalf of the Organization? If yes, identify them. | | |
