...
This is a CI-only delta gate, not part of the 41-gate corpus audit programme. The
41 corpus gates check repository state at HEAD; this script compares HEAD to the
