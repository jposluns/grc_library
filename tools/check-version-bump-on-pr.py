...
This is a PR-time delta gate (D2), not part of the corpus audit
...
docs/reference-acquisition-manifest.md); the five append-only .working/
...
from aiqt_corpus import git, git_show, head_version  # noqa: E402  # generic core (behaviour-identical to lint_common)
