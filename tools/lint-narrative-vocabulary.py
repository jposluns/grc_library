...
from lint_common import CROSS_EXTERNAL_CONTEXT_RE, REPO_ROOT, guard_explicit_paths_cwd, positional_args, flag_before_separator  # noqa: E402  # grc-config/store, stays local
