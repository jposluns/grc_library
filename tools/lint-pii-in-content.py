...
EXAMPLE_DOMAINS = {
    ...
    # GitHub Action / Actions docs frequently reference these:
    "noreply.github.com",
    # The library maintainer's contact domains (recorded in AUTHORS / CITATION):
    "posluns.com", "posluns.ca",
}
...
def is_target(path: Path) -> bool:
    # Include .md, .py, .yaml/.yml, .json, .txt, .cff. CITATION.cff is exempt by name.
    if path.suffix not in {".md", ".py", ".yaml", ".yml", ".json", ".toml", ".txt", ".cff"}:
        return False
