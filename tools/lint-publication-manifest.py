...
(PUBLIC / SANITIZE / WITHHELD). Origin: the publication-classification
work closed in PR #1374, a dual-family (Opus-5 + Codex) classification
reconciled, Fable-confirmed, maintainer GO 2026-08-03.
