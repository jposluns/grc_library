...
# `&& git push`. The full 99-gate tools/pre-push-guard.sh remains the AUTHORITY
...
echo "it runs all 99 gates incl. the register-guarded and corpus-wide ones this omits."
echo "------------------------------------------------------------"
