...
# `&& git push`. The full 87-gate tools/pre-push-guard.sh remains the AUTHORITY
...
echo "it runs all 87 gates incl. the register-guarded and corpus-wide ones this omits."
echo "------------------------------------------------------------"
