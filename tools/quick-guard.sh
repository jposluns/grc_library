...
# `&& git push`. The full 82-gate tools/pre-push-guard.sh remains the AUTHORITY
...
echo "it runs all 82 gates incl. the register-guarded and corpus-wide ones this omits."
echo "------------------------------------------------------------"
