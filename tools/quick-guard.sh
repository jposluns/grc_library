...
# `&& git push`. The full 100-gate tools/pre-push-guard.sh remains the AUTHORITY
...
echo "it runs all 100 gates incl. the register-guarded and corpus-wide ones this omits."
echo "------------------------------------------------------------"
