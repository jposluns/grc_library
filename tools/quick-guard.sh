...
# `&& git push`. The full 98-gate tools/pre-push-guard.sh remains the AUTHORITY
...
echo "it runs all 98 gates incl. the register-guarded and corpus-wide ones this omits."
echo "------------------------------------------------------------"
