...
# `&& git push`. The full 88-gate tools/pre-push-guard.sh remains the AUTHORITY
...
echo "it runs all 88 gates incl. the register-guarded and corpus-wide ones this omits."
echo "------------------------------------------------------------"
