...
# `&& git push`. The full 83-gate tools/pre-push-guard.sh remains the AUTHORITY
...
echo "it runs all 83 gates incl. the register-guarded and corpus-wide ones this omits."
echo "------------------------------------------------------------"
