...
# The current sweep is 44 gates; see governance/specification-audit-programme.md
...
# ----------------------------------------------------------------------
# Markdown linters (sub-group of the 44 corpus gates). Order mirrors quality.yml.
# ----------------------------------------------------------------------
